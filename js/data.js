// D&D 5E NPC Generator - Data
// All game data: races, classes, subclasses, occupations, weapons, spells, etc.
...
// Official D&D 5e Backgrounds (for PCs)
const backgrounds = {
    acolyte: {
        ...
        flaws: ['I judge others harshly, myself even more.', 'I trust those in power within my temple too much.', 'My piety leads me to blindly trust the faithful.', 'I am inflexible in my thinking.', 'I am suspicious of strangers.', 'I become obsessed with my goals.']
    },
    charlatan: {
        ...
        flaws: ['I cannot resist a pretty face.', 'I am always in debt.', 'I cannot help swindling the powerful.', 'I will run to save myself.', 'A secret could ruin my career.', 'I turn tail when things look bad.']
    },
    criminal: {
        ...
        flaws: ['I cannot help but plan to steal valuables.', 'I choose money over friends.', 'I forget plans easily.', 'I have a tell when I lie.', 'I run when things look bad.', 'An innocent is in prison for my crime.']
    },
    entertainer: {
        ...
        flaws: ['I will do anything for fame.', 'I am a sucker for a pretty face.', 'A scandal prevents me from going home.', 'A noble wants my head for a satire I performed.', 'I cannot hide my true feelings.', 'I am unreliable despite my best efforts.']
    },
    folkhero: {
        ...
        flaws: ['A tyrant will stop at nothing to destroy me.', 'I am overconfident in my abilities.', 'I secretly believe everyone is beneath me.', 'I have a weakness for city vices.', 'I expect the worst from strangers.', 'I have trouble trusting allies.']
    },
    hermit: {
        ...
        flaws: ['I enjoy worldly delights too much now.', 'I harbor dark thoughts isolation did not quell.', 'I am dogmatic in my philosophy.', 'I let arguments overshadow friendships.', 'I would risk too much for lost knowledge.', 'I keep secrets and will not share them.']
    },
    noble: {
        ...
        flaws: ['I believe everyone is beneath me.', 'I hide a scandalous secret.', 'I hear insults where none were intended.', 'I have an insatiable desire for pleasures.', 'The world does revolve around me.', 'I bring shame to my family.']
    },
    outlander: {
        ...
        flaws: ['I am too fond of ale.', 'There is no room for caution in a full life.', 'I remember every insult silently.', 'I am slow to trust other races.', 'Violence is my answer to challenges.', 'I do not expect a long life.']
    },
    sage: {
        ...
        flaws: ['I am easily distracted by information.', 'I stop and take notes when seeing a demon.', 'An ancient mystery is worth a civilization.', 'I overlook obvious solutions.', 'I speak without thinking.', 'I cannot keep a secret.']
    },
    sailor: {
        ...
        flaws: ['I follow orders even if wrong.', 'I will say anything to avoid extra work.', 'I never back down when my courage is questioned.', 'I cannot stop drinking once I start.', 'I pocket loose coins and trinkets.', 'My pride will lead to my destruction.']
    },
    soldier: {
        ...
        flaws: ['A monstrous enemy still makes me quiver.', 'I have little respect for non-warriors.', 'A battle mistake cost many lives.', 'My hatred of enemies is blind.', 'I obey the law even if it causes misery.', 'I would rather eat armor than admit I am wrong.']
    },
    urchin: {
...
const subclasses = {
    ...
    bard: {
        ...
        options: [
            ...
            { id: 'spirits', name: 'College of Spirits', source: 'VRGtR', description: 'Bards of the College of Spirits seek tales with inherent power—be they legends, histories, or fictions—and bring their subjects to life.', backstoryHook: 'who communes with the College of Spirits, channeling tales of the dead through séance and story' }
        ]
    },
    cleric: {
        level: 1,
        ...
        options: [
            ...
            { id: 'life', name: 'Life Domain', source: 'PHB', description: 'The Life domain focuses on the vibrant positive energy—one of the fundamental forces of the universe—that sustains all life.', backstoryHook: 'who channels the Life Domain, dedicated to healing and preserving life' },
    ...
    warlock: {
        ...
        options: [
            ...
            { id: 'hexblade', name: 'The Hexblade', source: 'XGtE', description: 'You have made your pact with a mysterious entity from the Shadowfell—a force that manifests in sentient magic weapons.', backstoryHook: 'who is bound to the Hexblade, wielding a weapon of shadow and curse' },
...
const subclassFeatures = {
    bard: {
        lore: [
            { level: 3, name: 'Bonus Proficiencies', description: 'At 3rd level you gain proficiency in any three skills you choose.' },
            { level: 3, name: 'Cutting Words', description: 'Also at 3rd level, when a creature you can see within 60 feet makes an attack roll, ability check, or damage roll, you can use your reaction to spend one Bardic Inspiration use. Roll the die and subtract it from that creature\'s roll. You decide after seeing the roll but before the outcome is set (or before damage is applied). Creatures that cannot hear you, or that are immune to being charmed, are unaffected.' },
            { level: 6, name: 'Additional Magical Secrets', description: 'At 6th level, choose two spells from any class\'s list (or cantrips). Each must be of a level you can cast. They count as bard spells for you and do not count against your Spells Known total.' },
            { level: 14, name: 'Peerless Skill', description: 'Starting at 14th level, when you make an ability check you can spend one Bardic Inspiration use, roll the die, and add it to the check. You may do this after rolling the check, but before the DM announces success or failure.' }
        ],
        valor: [
            { level: 3, name: 'Bonus Proficiencies', description: 'At 3rd level you gain proficiency with medium armor, shields, and martial weapons.' },
            { level: 3, name: 'Combat Inspiration', description: 'Also at 3rd level, a creature holding one of your Bardic Inspiration dice can spend it in combat in two ways: add the roll to a weapon damage roll it just made, or (as a reaction when attacked) add the roll to its AC against that attack after seeing the attack roll but before knowing if it hits.' },
            { level: 6, name: 'Extra Attack', description: 'Beginning at 6th level, when you take the Attack action on your turn you can make two attacks instead of one.' },
            { level: 14, name: 'Battle Magic', description: 'At 14th level, after you use your action to cast a bard spell, you can make one weapon attack as a bonus action.' }
        ],
        glamour: [
            { level: 3, name: 'Mantle of Inspiration', description: 'At 3rd level, as a bonus action you can spend one Bardic Inspiration use to take on a wondrous appearance and choose up to your Charisma modifier creatures (minimum 1) within 60 feet that can see you. Each gains temporary hit points (5 at 3rd level; 8 at 5th; 11 at 10th; 14 at 15th). When a creature gains those temporary hit points, it may immediately use its reaction to move up to its speed without provoking opportunity attacks.' },
            { level: 3, name: 'Enthralling Performance', description: 'Also at 3rd level, after you perform for at least 1 minute (song, poem, or dance), choose up to your Charisma modifier humanoids (minimum 1) within 60 feet who watched the whole performance. Each must succeed on a Wisdom save against your spell save DC or be charmed by you for 1 hour: they idolize you, praise you, and hinder your opponents (avoiding violence unless already inclined to fight for you). The charm ends early if the target takes damage, if you attack it, or if it sees you harm its allies. On a successful save, the target does not realize you tried to charm it. Once per short or long rest.' },
            { level: 6, name: 'Mantle of Majesty', description: 'At 6th level, as a bonus action you cast command without a spell slot and assume an unearthly appearance for 1 minute (concentration, as if concentrating on a spell). While it lasts, you can cast command as a bonus action on each of your turns without a spell slot. Creatures currently charmed by you automatically fail saves against those commands. Once per long rest.' },
            { level: 14, name: 'Unbreakable Majesty', description: 'At 14th level your appearance permanently takes on an otherworldly quality. In addition, as a bonus action you can assume a majestic presence for 1 minute (or until you are incapacitated). The first time each turn a creature tries to attack you, it must make a Charisma save against your spell save DC. On a failure it cannot attack you this turn and must pick a different target or waste the attack; on a success it can attack you, but has disadvantage on saves against your spells on your next turn. Once per short or long rest.' }
        ],
        swords: [
            { level: 3, name: 'Bonus Proficiencies', description: 'At 3rd level you gain proficiency with medium armor and the scimitar. Any simple or martial melee weapon you are proficient with can serve as a spellcasting focus for your bard spells.' },
            { level: 3, name: 'Fighting Style', description: 'Also at 3rd level, choose Dueling (+2 damage when wielding a one-handed melee weapon with no other weapon) or Two-Weapon Fighting (add your ability modifier to the damage of your off-hand attack). You cannot take the same Fighting Style option more than once.' },
            { level: 3, name: 'Blade Flourish', description: 'Also at 3rd level, whenever you take the Attack action on your turn your walking speed increases by 10 feet until the end of the turn. If a weapon attack from that action hits a creature, you may use one Blade Flourish option that turn (only one per turn): Defensive Flourish — spend a Bardic Inspiration use to add the die to the hit\'s damage and to your AC until the start of your next turn; Slashing Flourish — spend a use to add the die as damage to the target and to one other creature you can see within 5 feet of you; Mobile Flourish — spend a use to add the die as damage, push the target 5 feet plus a number of feet equal to the die result, then use your reaction to move up to your walking speed to an unoccupied space within 5 feet of the target.' },
            { level: 6, name: 'Extra Attack', description: 'Beginning at 6th level, when you take the Attack action on your turn you can make two attacks instead of one.' },
            { level: 14, name: 'Master\'s Flourish', description: 'Starting at 14th level, when you use a Blade Flourish option you can roll a d6 for the flourish\'s bonus instead of spending a Bardic Inspiration die.' }
        ],
        whispers: [
            { level: 3, name: 'Psychic Blades', description: 'At 3rd level, when you hit a creature with a weapon attack you can spend one Bardic Inspiration use to deal extra psychic damage: 2d6 at 3rd level, 3d6 at 5th, 5d6 at 10th, and 8d6 at 15th. You can apply this only once per round, on your turn.' },
            { level: 3, name: 'Words of Terror', description: 'Also at 3rd level, if you speak alone with a humanoid for at least 1 minute, at the end of the talk it must succeed on a Wisdom save against your spell save DC or be frightened of you or another creature you choose for 1 hour (ending early if it or its allies are attacked or damaged). On a successful save it does not realize you tried to frighten it. Once per short or long rest.' },
            { level: 6, name: 'Mantle of Whispers', description: 'At 6th level, when a humanoid dies within 30 feet of you, you can use your reaction to capture its shadow (kept until used or until you finish a long rest). As an action you expend the shadow to wear its likeness for 1 hour (or until ended as a bonus action), appearing as that person healthy and alive. While disguised you know surface details a casual acquaintance would know (not secrets), enough to pass as them. Another creature can see through the disguise with a Wisdom (Insight) check contested by your Charisma (Deception); you have a +5 bonus on that check. After capturing a shadow, you cannot capture another until you finish a short or long rest.' },
            { level: 14, name: 'Shadow Lore', description: 'At 14th level, as an action you whisper a phrase only one chosen creature within 30 feet can hear. It must make a Wisdom save against your spell save DC (automatically succeeding if it cannot hear you or share a language). On a success your words sound like nonsense. On a failure it is charmed for 8 hours (or until you or your allies attack it, damage it, or force a save), believing you know its most mortifying secret (you learn nothing of the secret). It obeys your commands out of fear but will not risk its life or fight for you unless already inclined. When the effect ends it does not understand why it feared you. Once per long rest.' }
        ],
        creation: [
            { level: 3, name: 'Mote of Potential', description: 'At 3rd level, whenever you give a creature a Bardic Inspiration die you can also create a Tiny intangible mote that orbits within 5 feet of it until the die is lost. When the die is used, the mote adds an effect: Ability check — the creature may reroll the Bardic Inspiration die and choose either result; Attack roll — after the die is added to an attack, the mote shatters and the target plus each creature of your choice within 5 feet of it must succeed on a Constitution save against your spell save DC or take thunder damage equal to the die; Saving throw — after the die is added to a save, the creature gains temporary hit points equal to the die plus your Charisma modifier (minimum 1).' },
            { level: 3, name: 'Performance of Creation', description: 'Also at 3rd level, as an action you create one nonmagical item in an unoccupied space within 10 feet (on a surface or liquid that can support it). Its gp value cannot exceed 20 × your bard level, and it must be Medium or smaller (Large at 6th level, Huge at 14th). It lasts a number of hours equal to your proficiency bonus, then vanishes. You can create only one such item at a time; creating another ends the first. After creating an item, you cannot do so again until you finish a long rest, unless you spend a spell slot of 2nd level or higher to use the feature again.' },
            { level: 6, name: 'Animating Performance', description: 'At 6th level, as an action you animate a Large or smaller nonmagical item within 30 feet as a Dancing Item (AC 16; HP 10 + five × your bard level; speed 30 ft., fly 30 ft. hover; Force-Empowered Slam using your spell attack bonus). It is friendly, obeys you, shares your initiative (acting after you), and lasts 1 hour, until reduced to 0 hit points, or until you die. On its turn it Dodges unless you use a bonus action to command another action (you can command it as part of the same bonus action used for Bardic Inspiration). Only one dancing item at a time. Once per long rest, or again by spending a spell slot of 3rd level or higher.' },
            { level: 14, name: 'Creative Crescendo', description: 'At 14th level, when you use Performance of Creation you can create a number of items equal to your Charisma modifier (minimum 2). Only one can be your maximum size; the rest must be Small or Tiny. Creating more than that limit ends older creations of your choice. You are no longer limited by gp value when creating items with Performance of Creation.' }
        ],
        eloquence: [
            { level: 3, name: 'Silver Tongue', description: 'At 3rd level, when you make a Charisma (Persuasion) or Charisma (Deception) check, treat a d20 roll of 9 or lower as a 10.' },
            { level: 3, name: 'Unsettling Words', description: 'Also at 3rd level, as a bonus action you can spend one Bardic Inspiration use and choose a creature you can see within 60 feet. Roll the die; that creature subtracts the result from the next saving throw it makes before the start of your next turn.' },
            { level: 6, name: 'Unfailing Inspiration', description: 'At 6th level, when a creature adds one of your Bardic Inspiration dice to an ability check, attack roll, or saving throw and still fails, it keeps the die instead of losing it.' },
            { level: 6, name: 'Universal Speech', description: 'Also at 6th level, as an action choose up to your Charisma modifier creatures (minimum 1) within 60 feet. For 1 hour they magically understand your speech regardless of language. Once per long rest, or again by spending a spell slot of any level.' },
            { level: 14, name: 'Infectious Inspiration', description: 'At 14th level, when a creature within 60 feet adds one of your Bardic Inspiration dice to a roll and succeeds, you can use your reaction to grant a different creature (not yourself) that can hear you within 60 feet a Bardic Inspiration die without spending one of your uses. You can use this reaction a number of times equal to your Charisma modifier (minimum once) per long rest.' }
        ],
        spirits: [
            // VRGtR not in local library — expanded paraphrase from known mechanics
            { level: 3, name: 'Guiding Whispers', description: 'At 3rd level you learn the guidance cantrip. It counts as a bard spell for you, and when you cast it using this feature its range is 60 feet.' },
            { level: 3, name: 'Spiritual Focus', description: 'Also at 3rd level you can use a candle, crystal ball, skull, spirit board, or similar occult object as a spellcasting focus for bard spells. While holding such a focus, whenever you cast a bard spell that deals damage or restores hit points, you can roll a d6 and add the result to one damage or healing roll of that spell (improving to a d8 at 6th level and a d10 at 14th level).' },
            { level: 3, name: 'Tales from Beyond', description: 'Also at 3rd level, as a bonus action you can spend one Bardic Inspiration use to roll on the Spirit Tales table and channel a tale (such as tales of cheer, fear, or revenge). You can hold one tale at a time and unleash its effect as an action; if you roll a new tale while holding one, you choose which to keep. Effects typically target creatures within 30 feet and use your spell save DC where saves apply.' },
            { level: 6, name: 'Spirit Session', description: 'At 6th level, you can conduct a 1-minute séance with a number of willing creatures equal to your proficiency bonus (including yourself). At the end, you temporarily learn one divination or necromancy spell of a level you can cast from any class list; it counts as a bard spell for you until you finish a long rest. Once per long rest.' },
            { level: 14, name: 'Mystical Connection', description: 'At 14th level, whenever you roll on the Spirit Tales table you can roll twice and choose which result to use.' }
        ]
    },
    barbarian: {
        berserker: [
            { level: 3, name: 'Frenzy', description: 'When you enter a rage, you may choose to frenzy. While frenzied, after the turn you start the rage you can make one melee weapon attack as a bonus action on each of your turns for the rage\'s duration. When the rage ends, you gain one level of exhaustion.' },
            { level: 6, name: 'Mindless Rage', description: 'While raging you are immune to being charmed and frightened. If either condition already affects you when the rage begins, it is suppressed until the rage ends.' },
            { level: 10, name: 'Intimidating Presence', description: 'As an action, choose one creature you can see within 30 feet that can see or hear you. It must succeed on a Wisdom save (DC 8 + your proficiency bonus + your Charisma modifier) or be frightened of you until the end of your next turn. On later turns you can use your action to keep it frightened until the end of your next turn; the effect ends early if it ends its turn out of your sight or more than 60 feet away. A creature that succeeds on the save is immune to this feature for 24 hours.' },
            { level: 14, name: 'Retaliation', description: 'When a creature within 5 feet of you deals damage to you, you can use your reaction to make one melee weapon attack against that creature.' }
        ],
        'totem-warrior': [
            { level: 3, name: 'Spirit Seeker & Totem Spirit', description: 'You can cast beast sense and speak with animals only as rituals. You also choose a totem spirit (Bear, Eagle, or Wolf; Elk or Tiger options from some settings): Bear — while raging, resistance to all damage except psychic; Eagle — while raging, opportunity attacks against you have disadvantage and you can Dash as a bonus action; Wolf — while raging, allies have advantage on melee attacks against hostile creatures within 5 feet of you; Elk — while raging and not in heavy armor, +15 ft. walking speed; Tiger — while raging, +10 ft. to long jumps and +3 ft. to high jumps.' },
            { level: 6, name: 'Aspect of the Beast', description: 'Choose a totem (same or different): Bear — double carrying capacity and advantage on Strength checks to push, pull, lift, or break objects; Eagle — see up to 1 mile with fine detail as if within 100 feet, and dim light does not impose disadvantage on Wisdom (Perception); Wolf — track while traveling at a fast pace, and travel stealthily at a normal pace; Elk — your travel pace (and that of up to 10 companions within 60 feet while you are not incapacitated) is doubled; Tiger — proficiency in two skills from Athletics, Acrobatics, Stealth, and Survival.' },
            { level: 10, name: 'Spirit Walker', description: 'You can cast commune with nature only as a ritual. When you do, a spiritual form of one animal you chose for Totem Spirit or Aspect of the Beast appears to convey the spell\'s information.' },
            { level: 14, name: 'Totemic Attunement', description: 'Choose a totem (same or different) while raging: Bear — hostile creatures within 5 feet have disadvantage on attack rolls against targets other than you (or another character with this feature), unless they cannot see/hear you or cannot be frightened; Eagle — flying speed equal to your walking speed, but you fall if you end your turn aloft with nothing holding you up; Wolf — when you hit a Large or smaller creature with a melee weapon attack, you can use a bonus action to knock it prone; Elk — as a bonus action during your move, pass through a Large or smaller creature\'s space; it must succeed on a Strength save (DC 8 + your Strength modifier + your proficiency bonus) or fall prone and take bludgeoning damage equal to 1d12 + your Strength modifier; Tiger — if you move at least 20 feet straight toward a Large or smaller target before a melee weapon attack, you can make an additional melee weapon attack against it as a bonus action.' }
        ],
        'ancestral-guardian': [
            { level: 3, name: 'Ancestral Protectors', description: 'While raging, the first creature you hit with an attack on your turn is marked by spectral warriors until the start of your next turn (or until your rage ends). That target has disadvantage on attack rolls that are not against you, and when it hits a creature other than you with an attack, that creature has resistance to the damage of the attack.' },
            { level: 6, name: 'Spirit Shield', description: 'While raging, when another creature you can see within 30 feet takes damage, you can use your reaction to reduce that damage by 2d6 (3d6 at 10th level, 4d6 at 14th level).' },
            { level: 10, name: 'Consult the Spirits', description: 'You cast augury or clairvoyance without a spell slot or material components (Wisdom is your spellcasting ability). Clairvoyance used this way summons an invisible ancestral spirit to the chosen location instead of creating a sensor. Once per short or long rest.' },
            { level: 14, name: 'Vengeful Ancestors', description: 'When you reduce damage with Spirit Shield against an attack, the attacker takes force damage equal to the amount of damage Spirit Shield prevented.' }
        ],
        'storm-herald': [
            { level: 3, name: 'Storm Aura', description: 'While raging you emit a 10-foot aura (blocked by total cover). Choose Desert, Sea, or Tundra (changeable when you gain a barbarian level). The aura\'s effect triggers when you enter the rage and again as a bonus action on later turns. Saves use DC 8 + your proficiency bonus + your Constitution modifier. Desert — each other creature in the aura takes 2 fire damage (3 at 5th, 4 at 10th, 5 at 15th, 6 at 20th). Sea — one other creature you can see in the aura makes a Dexterity save, taking 1d6 lightning damage on a failure or half on a success (2d6 at 10th, 3d6 at 15th, 4d6 at 20th). Tundra — each creature of your choice in the aura gains 2 temporary hit points (3 at 5th, 4 at 10th, 5 at 15th, 6 at 20th).' },
            { level: 6, name: 'Storm Soul', description: 'Benefits based on your Storm Aura environment, even when not raging: Desert — fire resistance, ignore extreme heat, and as an action ignite a flammable object you touch that nobody else is wearing or carrying; Sea — lightning resistance, underwater breathing, and a 30-foot swimming speed; Tundra — cold resistance, ignore extreme cold, and as an action freeze a 5-foot cube of water you touch into ice for 1 minute (fails if a creature is in the cube).' },
            { level: 10, name: 'Shielding Storm', description: 'While in your Storm Aura, each creature of your choice gains the damage resistance granted by your Storm Soul feature.' },
            { level: 14, name: 'Raging Storm', description: 'Based on your environment: Desert — when a creature in your aura hits you with an attack, you can use your reaction to force a Dexterity save; on a failure it takes fire damage equal to half your barbarian level; Sea — when you hit a creature in your aura with an attack, you can use your reaction to force a Strength save or knock it prone; Tundra — when your Storm Aura effect activates, choose one creature you can see in the aura; it must succeed on a Strength save or have its speed reduced to 0 until the start of your next turn.' }
        ],
        zealot: [
            { level: 3, name: 'Divine Fury & Warrior of the Gods', description: 'While raging, the first creature you hit each turn with a weapon attack takes extra necrotic or radiant damage (your choice when you gain this feature) equal to 1d6 + half your barbarian level. Additionally, if a spell\'s only effect is to restore you to life (not undeath), the caster needs no material components when casting it on you.' },
            { level: 6, name: 'Fanatical Focus', description: 'Once per rage, if you fail a saving throw while raging, you can reroll it and must use the new result.' },
            { level: 10, name: 'Zealous Presence', description: 'As a bonus action, choose up to ten other creatures within 60 feet that can hear you. Until the start of your next turn they have advantage on attack rolls and saving throws. Once per long rest.' },
            { level: 14, name: 'Rage Beyond Death', description: 'While raging, having 0 hit points does not knock you unconscious. You still make death saving throws and suffer normal effects of taking damage at 0 hit points, but if you would die from failed death saves you do not die until your rage ends—and then only if you still have 0 hit points.' }
        ],
        battlerager: [
            { level: 3, name: 'Battlerager Armor', description: 'While wearing spiked armor and raging, you can use a bonus action to make one melee weapon attack with your armor spikes against a target within 5 feet (1d4 piercing damage; Strength for attack and damage). Additionally, when you use the Attack action to grapple a creature and succeed, the target takes 3 piercing damage.' },
            { level: 6, name: 'Reckless Abandon', description: 'When you use Reckless Attack while raging, you also gain temporary hit points equal to your Constitution modifier (minimum 1). Any remaining temporary hit points from this feature vanish when your rage ends.' },
            { level: 10, name: 'Battlerager Charge', description: 'While raging, you can take the Dash action as a bonus action.' },
            { level: 14, name: 'Spiked Retribution', description: 'While raging, not incapacitated, and wearing spiked armor, when a creature within 5 feet hits you with a melee attack, the attacker takes 3 piercing damage.' }
        ],
        beast: [
            { level: 3, name: 'Form of the Beast', description: 'When you enter a rage, you can manifest a natural weapon until the rage ends (simple melee weapon; add Strength to attack and damage). Choose each rage: Bite — 1d8 piercing; once per turn when you damage a creature with it while you have fewer than half your hit points, regain hit points equal to your proficiency bonus; Claws — 1d6 slashing with an empty hand; once per turn when you attack with a claw as part of the Attack action, make one extra claw attack as part of that action; Tail — 1d8 piercing with reach; when a creature you can see within 10 feet hits you with an attack, you can use your reaction to roll a d8 and add it to your AC against that attack.' },
            { level: 6, name: 'Bestial Soul', description: 'Your Form of the Beast natural weapons count as magical for overcoming resistance and immunity to nonmagical attacks and damage. When you finish a short or long rest, choose one benefit until your next rest: swimming speed equal to your walking speed and underwater breathing; climbing speed equal to your walking speed and climb difficult surfaces (including ceilings) without an ability check; or when you jump, once per turn make a Strength (Athletics) check and add the total (in feet) to the jump distance.' },
            { level: 10, name: 'Infectious Fury', description: 'When you hit a creature with your natural weapons while raging, you can force it to make a Wisdom save (DC 8 + your Constitution modifier + your proficiency bonus). On a failure, choose: it uses its reaction to make a melee attack against another creature of your choice that you can see, or it takes 2d12 psychic damage. Uses equal to your proficiency bonus per long rest.' },
            { level: 14, name: 'Call the Hunt', description: 'When you enter a rage, you can choose a number of other willing creatures you can see within 30 feet equal to your Constitution modifier (minimum 1). You gain 5 temporary hit points per creature that accepts. Until the rage ends, each chosen creature can once per turn, when it hits and deals damage with an attack, roll a d6 and add it to that damage. Uses equal to your proficiency bonus per long rest.' }
        ],
        'wild-magic': [
            { level: 3, name: 'Magic Awareness & Wild Surge', description: 'As an action, until the end of your next turn you know the location of any spell or magic item within 60 feet not behind total cover, and learn the school of any sensed spell. Uses equal to your proficiency bonus per long rest. Also, when you enter a rage, roll on the Wild Magic table for a random effect (saves use DC 8 + your proficiency bonus + your Constitution modifier); effects can include necrotic lashes with temporary hit points, teleportation, exploding spirits, force-infused weapons, retaliatory force damage, AC bonuses, difficult terrain for enemies, or radiant blindness bolts.' },
            { level: 6, name: 'Bolstering Magic', description: 'As an action, touch yourself or another creature and choose: for 10 minutes it adds a d3 to attack rolls and ability checks; or roll a d3 and the creature regains one expended spell slot of that level or lower (a creature can receive the slot restoration only once per long rest). Uses equal to your proficiency bonus per long rest.' },
            { level: 10, name: 'Unstable Backlash', description: 'Immediately after you take damage or fail a saving throw while raging, you can use your reaction to roll on the Wild Magic table and produce that effect, replacing your current Wild Magic effect.' },
            { level: 14, name: 'Controlled Surge', description: 'Whenever you roll on the Wild Magic table, roll twice and choose which effect to use. If both dice show the same number, you may ignore the result and pick any effect on the table.' }
        ]
    },
    cleric: {
        knowledge: [
            { level: 1, name: 'Blessings of Knowledge', description: 'You learn two languages of your choice. Choose two skills from Arcana, History, Nature, and Religion; you gain proficiency in them, and your proficiency bonus is doubled for any ability check using either skill.' },
            { level: 2, name: 'Channel Divinity: Knowledge of the Ages', description: 'As an action, choose one skill or tool. For 10 minutes you have proficiency with it.' },
            { level: 6, name: 'Channel Divinity: Read Thoughts', description: 'As an action, choose a creature you can see within 60 feet. It makes a Wisdom save against your spell save DC; on a success you cannot use this feature on it again until you finish a long rest. On a failure, for 1 minute you can read its surface thoughts while it remains within 60 feet. During that time you can use your action to end the effect and cast suggestion on it without a spell slot; it automatically fails its save against that spell.' },
            { level: 8, name: 'Potent Spellcasting', description: 'Add your Wisdom modifier to the damage you deal with any cleric cantrip.' },
            { level: 17, name: 'Visions of the Past', description: 'Spend at least 1 minute meditating (concentration as if casting a spell) for up to a number of minutes equal to your Wisdom score, then once per short or long rest: Object Reading — after 1 minute holding an object, learn how its previous owner acquired and lost it and the most significant recent event involving them; for each additional minute you can learn the same about another owner within a number of days equal to your Wisdom score. Area Reading — learn significant events in an up to 50-foot cube around you going back a number of days equal to your Wisdom score, one event per minute of meditation starting with the most recent.' }
        ],
        life: [
            { level: 1, name: 'Bonus Proficiency & Disciple of Life', description: 'You gain proficiency with heavy armor. Whenever you use a spell of 1st level or higher to restore hit points to a creature, that creature also regains additional hit points equal to 2 + the spell\'s level.' },
            { level: 2, name: 'Channel Divinity: Preserve Life', description: 'As an action, restore a pool of hit points equal to five times your cleric level, divided as you choose among any creatures within 30 feet. No creature can be restored above half its hit point maximum. Undead and constructs are unaffected.' },
            { level: 6, name: 'Blessed Healer', description: 'When you cast a spell of 1st level or higher that restores hit points to a creature other than you, you also regain hit points equal to 2 + the spell\'s level.' },
            { level: 8, name: 'Divine Strike', description: 'Once on each of your turns when you hit a creature with a weapon attack, you can deal an extra 1d8 radiant damage. At 14th level this increases to 2d8.' },
            { level: 17, name: 'Supreme Healing', description: 'When you would roll one or more dice to restore hit points with a spell, instead treat each die as its maximum value (for example, 2d6 restores 12).' }
        ],
        light: [
            { level: 1, name: 'Bonus Cantrip & Warding Flare', description: 'You learn the light cantrip if you do not already know it. When you are attacked by a creature you can see within 30 feet, you can use your reaction to impose disadvantage on that attack roll (creatures that cannot be blinded are immune). Uses equal to your Wisdom modifier (minimum once) per long rest.' },
            { level: 2, name: 'Channel Divinity: Radiance of the Dawn', description: 'As an action, magical darkness within 30 feet of you is dispelled. Each hostile creature within 30 feet (that does not have total cover from you) must make a Constitution save against your spell save DC, taking radiant damage equal to 2d10 + your cleric level on a failure, or half as much on a success.' },
            { level: 6, name: 'Improved Flare', description: 'You can also use Warding Flare when a creature you can see within 30 feet attacks a creature other than you.' },
            { level: 8, name: 'Potent Spellcasting', description: 'Add your Wisdom modifier to the damage you deal with any cleric cantrip.' },
            { level: 17, name: 'Corona of Light', description: 'As an action, activate an aura for 1 minute (or dismiss it with another action): bright light in a 60-foot radius and dim light 30 feet beyond. Enemies in the bright light have disadvantage on saving throws against any spell that deals fire or radiant damage.' }
        ],
        nature: [
            { level: 1, name: 'Acolyte of Nature & Bonus Proficiency', description: 'You learn one druid cantrip of your choice, gain proficiency in one skill of your choice from Animal Handling, Nature, or Survival, and gain proficiency with heavy armor.' },
            { level: 2, name: 'Channel Divinity: Charm Animals and Plants', description: 'As an action, each beast or plant creature that can see you within 30 feet must make a Wisdom save against your spell save DC. On a failure it is charmed by you for 1 minute or until it takes damage, and while charmed it is friendly to you and creatures you designate.' },
            { level: 6, name: 'Dampen Elements', description: 'When you or a creature within 30 feet of you takes acid, cold, fire, lightning, or thunder damage, you can use your reaction to grant that creature resistance to that instance of the damage.' },
            { level: 8, name: 'Divine Strike', description: 'Once on each of your turns when you hit a creature with a weapon attack, you can deal an extra 1d8 cold, fire, or lightning damage (your choice). At 14th level this increases to 2d8.' },
            { level: 17, name: 'Master of Nature', description: 'While creatures are charmed by your Charm Animals and Plants feature, you can use a bonus action on your turn to verbally command what each of them will do on its next turn.' }
        ],
        tempest: [
            { level: 1, name: 'Wrath of the Storm & Bonus Proficiencies', description: 'You gain proficiency with martial weapons and heavy armor. When a creature you can see within 5 feet hits you with an attack, you can use your reaction to force a Dexterity save against your spell save DC; it takes 2d8 lightning or thunder damage (your choice) on a failure, or half as much on a success. Uses equal to your Wisdom modifier (minimum once) per long rest.' },
            { level: 2, name: 'Channel Divinity: Destructive Wrath', description: 'When you roll lightning or thunder damage, you can use your Channel Divinity to deal the maximum possible damage instead of rolling.' },
            ...
            { level: 8, name: 'Divine Strike', description: 'Once on each of your turns when you hit a creature with a weapon attack, you can deal an extra 1d8 thunder damage. At 14th level this increases to 2d8.' },
            { level: 17, name: 'Stormborn', description: 'Whenever you are not underground or indoors, you have a flying speed equal to your current walking speed.' }
        ],
        trickery: [
            { level: 1, name: 'Blessing of the Trickster', description: 'As an action, touch a willing creature other than yourself to give it advantage on Dexterity (Stealth) checks for 1 hour or until you use this feature again.' },
            { level: 2, name: 'Channel Divinity: Invoke Duplicity', description: 'As an action, create a perfect illusion of yourself in an unoccupied space you can see within 30 feet. It lasts 1 minute or until you lose concentration (as if concentrating on a spell). As a bonus action you can move it up to 30 feet to a space you can see, remaining within 120 feet of you. For the duration you can cast spells as though you were in its space (using your own senses), and when both you and the illusion are within 5 feet of a creature that can see the illusion, you have advantage on attack rolls against that creature.' },
            ...
            { level: 8, name: 'Divine Strike', description: 'Once on each of your turns when you hit a creature with a weapon attack, you can deal an extra 1d8 poison damage. At 14th level this increases to 2d8.' },
            { level: 17, name: 'Improved Duplicity', description: 'When you use Invoke Duplicity you can create up to four duplicates instead of one. As a bonus action you can move any number of them up to 30 feet each, to a maximum of 120 feet from you.' }
        ],
        war: [
            { level: 1, name: 'War Priest & Bonus Proficiencies', description: 'You gain proficiency with martial weapons and heavy armor. When you take the Attack action, you can make one weapon attack as a bonus action. Uses equal to your Wisdom modifier (minimum once) per long rest.' },
            { level: 2, name: 'Channel Divinity: Guided Strike', description: 'When you make an attack roll, you can use your Channel Divinity to gain a +10 bonus to the roll after seeing the roll but before knowing whether it hits or misses.' },
            { level: 6, name: 'Channel Divinity: War God\'s Blessing', description: 'When a creature within 30 feet of you makes an attack roll, you can use your reaction and Channel Divinity to grant that creature a +10 bonus to the roll after seeing the roll but before knowing whether it hits or misses.' },
            { level: 8, name: 'Divine Strike', description: 'Once on each of your turns when you hit a creature with a weapon attack, you can deal an extra 1d8 damage of the same type dealt by the weapon. At 14th level this increases to 2d8.' },
        ...
        death: [
            { level: 1, name: 'Reaper', description: 'You gain proficiency with martial weapons. You also learn one necromancy cantrip of your choice from any spell list. When you cast a necromancy cantrip that normally targets only one creature, you can instead target two creatures within range that are within 5 feet of each other.' },
            { level: 2, name: 'Channel Divinity: Touch of Death', description: 'When you hit a creature with a melee attack, you can use Channel Divinity to deal extra necrotic damage to the target equal to 5 + twice your cleric level.' },
            ...
            { level: 8, name: 'Divine Strike', description: 'Once on each of your turns when you hit a creature with a weapon attack, you can deal an extra 1d8 necrotic damage. At 14th level this increases to 2d8.' },
            { level: 17, name: 'Improved Reaper', description: 'When you cast a necromancy spell of 1st through 5th level that targets only one creature, you can instead target two creatures within range that are within 5 feet of each other. If the spell consumes its material components, you must provide them for each target.' }
        ],
        arcana: [
            { level: 1, name: 'Arcane Initiate', description: 'You gain proficiency in the Arcana skill and learn two cantrips of your choice from the wizard spell list. Those cantrips count as cleric cantrips for you.' },
            { level: 2, name: 'Channel Divinity: Arcane Abjuration', description: 'As an action, choose one celestial, elemental, fey, or fiend within 30 feet that can see or hear you. It must make a Wisdom save against your spell save DC or be turned for 1 minute or until it takes damage (must Dash away, cannot willingly end its move within 30 feet of you, and cannot take reactions). Starting at 5th level, a creature that fails and is not on its plane of origin is instead banished for 1 minute (as banishment, no concentration) if its CR is at or below: 1/2 at 5th, 1 at 8th, 2 at 11th, 3 at 14th, 4 at 17th.' },
            { level: 6, name: 'Spell Breaker', description: 'When you restore hit points to an ally with a spell of 1st level or higher, you can also end one spell of your choice on that creature whose level is equal to or lower than the spell slot you used for the healing spell.' },
            { level: 8, name: 'Potent Spellcasting', description: 'Add your Wisdom modifier to the damage you deal with any cleric cantrip.' },
            { level: 17, name: 'Arcane Mastery', description: 'Choose four wizard spells, one each of 6th, 7th, 8th, and 9th level, and add them to your domain spells. They are always prepared and count as cleric spells for you.' }
        ],
        forge: [
            { level: 1, name: 'Bonus Proficiencies & Blessing of the Forge', description: 'You gain proficiency with heavy armor and smith\'s tools. At the end of a long rest, touch one nonmagical suit of armor or simple or martial weapon; until the end of your next long rest or until you die, it becomes a magic item granting +1 to AC (armor) or +1 to attack and damage rolls (weapon). Once per long rest.' },
            { level: 2, name: 'Channel Divinity: Artisan\'s Blessing', description: 'Conduct a 1-hour ritual to craft a nonmagical item that includes some metal (weapon, armor, ten pieces of ammunition, tools, or another metal object) worth no more than 100 gp. Lay out metal (including coins) of equal value that is consumed and transformed; the item appears in an unoccupied space on a surface within 5 feet. You can duplicate a nonmagical metal-containing item if you possess the original during the ritual.' },
            { level: 6, name: 'Soul of the Forge', description: 'You gain resistance to fire damage. While wearing heavy armor, you also gain a +1 bonus to AC.' },
            { level: 8, name: 'Divine Strike', description: 'Once on each of your turns when you hit a creature with a weapon attack, you can deal an extra 1d8 fire damage. At 14th level this increases to 2d8.' },
            { level: 17, name: 'Saint of Forge and Fire', description: 'You gain immunity to fire damage. While wearing heavy armor, you also have resistance to bludgeoning, piercing, and slashing damage from nonmagical attacks.' }
        ],
        grave: [
            { level: 1, name: 'Circle of Mortality & Eyes of the Grave', description: 'When you would roll dice to restore hit points with a spell to a creature at 0 hit points, instead use the maximum on each die. You also learn spare the dying (does not count against cantrips known); for you it has a range of 30 feet and can be cast as a bonus action. As an action (uses equal to your Wisdom modifier, minimum once, per long rest), until the end of your next turn you know the location of any undead within 60 feet that is not behind total cover or protected from divination magic (no information about capabilities or identity).' },
            { level: 2, name: 'Channel Divinity: Path to the Grave', description: 'As an action, choose one creature you can see within 30 feet and curse it until the end of your next turn. The next time you or an ally hits the cursed creature with an attack, the creature has vulnerability to all of that attack\'s damage, then the curse ends.' },
            { level: 6, name: 'Sentinel at Death\'s Door', description: 'As a reaction when you or a creature you can see within 30 feet suffers a critical hit, turn that hit into a normal hit (effects that trigger on a critical hit are canceled). Uses equal to your Wisdom modifier (minimum once) per long rest.' },
            { level: 8, name: 'Potent Spellcasting', description: 'Add your Wisdom modifier to the damage you deal with any cleric cantrip.' },
            { level: 17, name: 'Keeper of Souls', description: 'When an enemy you can see dies within 60 feet of you and you are not incapacitated, you or one creature of your choice within 60 feet regains hit points equal to the enemy\'s number of Hit Dice. Once per turn (cannot use again until the start of your next turn).' }
        ],
        order: [
            { level: 1, name: 'Bonus Proficiencies & Voice of Authority', description: 'You gain proficiency with heavy armor and proficiency in Intimidation or Persuasion (your choice). When you cast a spell with a spell slot of 1st level or higher and target an ally with it, that ally can use its reaction immediately after the spell to make one weapon attack against a creature of your choice that you can see. If the spell targets more than one ally, you choose which ally gains the attack.' },
            { level: 2, name: 'Channel Divinity: Order\'s Demand', description: 'As an action, each creature of your choice that can see or hear you within 30 feet must succeed on a Wisdom save against your spell save DC or be charmed by you until the end of your next turn or until it takes damage. You can also cause any creatures that fail to drop what they are holding.' },
            { level: 6, name: 'Embodiment of the Law', description: 'When you cast an enchantment spell using a spell slot of 1st level or higher with a normal casting time of 1 action, you can change that casting\'s time to 1 bonus action. Uses equal to your Wisdom modifier (minimum once) per long rest.' },
            { level: 8, name: 'Divine Strike', description: 'Once on each of your turns when you hit a creature with a weapon attack, you can deal an extra 1d8 psychic damage. At 14th level this increases to 2d8.' },
            { level: 17, name: 'Order\'s Wrath', description: 'Once per turn, when you deal your Divine Strike damage to a creature, you can curse it until the start of your next turn. The next time one of your allies hits the cursed creature with an attack, the target also takes 2d8 psychic damage and the curse ends.' }
        ],
        peace: [
            { level: 1, name: 'Implement of Peace & Emboldening Bond', description: 'You gain proficiency in Insight, Performance, or Persuasion (your choice). As an action, choose a number of willing creatures within 30 feet (including yourself) equal to your proficiency bonus and bond them for 10 minutes or until you use this feature again. While any bonded creature is within 30 feet of another, it can roll a d4 and add it to an attack roll, ability check, or saving throw (once per turn). Uses equal to your proficiency bonus per long rest.' },
            { level: 2, name: 'Channel Divinity: Balm of Peace', description: 'As an action, move up to your speed without provoking opportunity attacks. When you move within 5 feet of any other creature during this action, you can restore hit points to it equal to 2d6 + your Wisdom modifier (minimum 1). A creature can receive this healing only once per use of this action.' },
            { level: 6, name: 'Protective Bond', description: 'When a creature affected by your Emboldening Bond is about to take damage, a second bonded creature within 30 feet can use its reaction to teleport to an unoccupied space within 5 feet of the first creature and take all of that damage instead.' },
            { level: 8, name: 'Potent Spellcasting', description: 'Add your Wisdom modifier to the damage you deal with any cleric cantrip.' },
            { level: 17, name: 'Expansive Bond', description: 'Emboldening Bond and Protective Bond now work when bonded creatures are within 60 feet of each other. Additionally, when a creature uses Protective Bond to take someone else\'s damage, it has resistance to that damage.' }
        ],
        twilight: [
            { level: 1, name: 'Bonus Proficiencies, Eyes of Night & Vigilant Blessing', description: 'You gain proficiency with martial weapons and heavy armor. You have darkvision out to 300 feet (dim light as bright, darkness as dim). As an action, share that darkvision with willing creatures you can see within 10 feet, up to your Wisdom modifier creatures (minimum 1), for 1 hour; once per long rest, or again by expending a spell slot of any level. As an action, touch a creature (including yourself) to grant advantage on its next initiative roll; ends after the roll or if you use this feature again.' },
            { level: 2, name: 'Channel Divinity: Twilight Sanctuary', description: 'As an action, create a 30-foot-radius sphere of dim light centered on you that moves with you for 1 minute (or until you are incapacitated or die). Whenever a creature (including you) ends its turn in the sphere, you can grant it temporary hit points equal to 1d6 + your cleric level, or end one effect causing it to be charmed or frightened.' },
            { level: 6, name: 'Steps of Night', description: 'As a bonus action while you are in dim light or darkness, give yourself a flying speed equal to your walking speed for 1 minute. Uses equal to your proficiency bonus per long rest.' },
            { level: 8, name: 'Divine Strike', description: 'Once on each of your turns when you hit a creature with a weapon attack, you can deal an extra 1d8 radiant damage. At 14th level this increases to 2d8.' },
            { level: 17, name: 'Twilight Shroud', description: 'You and your allies have half cover while in the sphere created by your Twilight Sanctuary.' }
        ]
    },
    druid: {
        land: [
            { level: 2, name: "Bonus Cantrip & Natural Recovery", description: "At 2nd level you learn one extra druid cantrip of your choice. Also at 2nd level, during a short rest you can recover expended spell slots whose combined level is no more than half your druid level (rounded up); none may be 6th level or higher. Once per long rest." },
            { level: 6, name: "Land's Stride", description: "Starting at 6th level, nonmagical difficult terrain costs you no extra movement, and you can pass through nonmagical plants without being slowed or harmed by thorns or similar hazards. You also have advantage on saves against plants magically created or manipulated to impede movement (such as entangle)." },
            { level: 10, name: "Nature's Ward", description: "At 10th level you can't be charmed or frightened by elementals or fey, and you are immune to poison and disease." },
            { level: 14, name: "Nature's Sanctuary", description: "At 14th level, when a beast or plant creature attacks you it must make a Wisdom save against your druid spell save DC. On a failure it must choose a different target or the attack misses; on a success it is immune to this effect for 24 hours. It knows about the effect before attacking." }
        ],
        moon: [
            { level: 2, name: "Combat Wild Shape & Circle Forms", description: "At 2nd level you can Wild Shape as a bonus action. While transformed, you can use a bonus action to expend a spell slot and regain 1d8 hit points per slot level. You can also transform into a beast of CR 1 (ignoring the usual Max CR column). From 6th level the max CR is your druid level divided by 3 (rounded down)." },
            { level: 6, name: "Primal Strike", description: "Starting at 6th level, your attacks in beast form count as magical for overcoming resistance and immunity to nonmagical attacks and damage." },
            { level: 10, name: "Elemental Wild Shape", description: "At 10th level you can expend two uses of Wild Shape at once to transform into an air, earth, fire, or water elemental." },
            { level: 14, name: "Thousand Forms", description: "By 14th level you can cast alter self at will." }
        ],
        dreams: [
            { level: 2, name: "Balm of the Summer Court", description: "At 2nd level you have a pool of d6s equal to your druid level. As a bonus action, choose a creature you can see within 120 feet and spend up to half your druid level dice from the pool. The target regains hit points equal to the total and gains 1 temporary hit point per die spent. All dice return on a long rest." },
            { level: 6, name: "Hearth of Moonlight and Shadow", description: "At 6th level, at the start of a short or long rest you can create an invisible 30-foot-radius sphere of magic (total cover blocks it). While inside, you and allies gain +5 to Dexterity (Stealth) and Wisdom (Perception) checks, and light from open flames in the sphere isn't visible outside. The sphere ends when the rest ends or you leave it." },
            { level: 10, name: "Hidden Paths", description: "Starting at 10th level, as a bonus action you can teleport up to 60 feet to an unoccupied space you can see, or as an action teleport a willing creature you touch up to 30 feet. Uses equal to your Wisdom modifier (minimum 1) per long rest." },
            { level: 14, name: "Walker in Dreams", description: "At 14th level, when you finish a short rest you can cast dream (you as messenger), scrying, or teleportation circle without a spell slot or materials. Your teleportation circle instead opens to the last place you finished a long rest on your current plane (fails without wasting the use if you haven't). Once per long rest." }
        ],
        shepherd: [
            { level: 2, name: "Speech of the Woods & Spirit Totem", description: "At 2nd level you learn Sylvan; beasts understand your speech and you can decipher theirs. Also as a bonus action you summon an incorporeal Bear, Hawk, or Unicorn spirit within 60 feet with a 30-foot aura for 1 minute (move it 60 feet as a bonus action). Bear: chosen creatures gain temp HP equal to 5 + your druid level and allies have advantage on Strength checks and saves in the aura. Hawk: reaction to grant advantage on an attack against a target in the aura; allies have advantage on Perception in the aura. Unicorn: advantage to detect creatures in the aura; when you heal with a spell slot, chosen creatures in the aura also heal equal to your druid level. Once per short or long rest." },
            { level: 6, name: "Mighty Summoner", description: "Starting at 6th level, beasts and fey you summon or create with a spell appear with 2 extra hit points per Hit Die, and their natural weapon damage counts as magical for overcoming nonmagical resistance and immunity." },
            { level: 10, name: "Guardian Spirit", description: "Beginning at 10th level, when a beast or fey you summoned or created with a spell ends its turn in your Spirit Totem aura, it regains hit points equal to half your druid level." },
            { level: 14, name: "Faithful Summons", description: "Starting at 14th level, if you are reduced to 0 hit points or incapacitated against your will, you immediately gain the benefits of conjure animals as a 9th-level spell: four beasts of CR 2 or lower appear within 20 feet, protect you if uncommanded, last 1 hour with no concentration, and can be dismissed for free. Once per long rest." }
        ],
        spores: [
            { level: 2, name: "Halo of Spores & Symbiotic Entity", description: "At 2nd level you learn chill touch and gain circle spells. When a creature you can see moves within 10 feet of you or starts its turn there, you can use your reaction to deal 1d4 necrotic damage (Constitution save vs your spell save DC negates); the die increases to 1d6 at 6th, 1d8 at 10th, and 1d10 at 14th. Also as an action you can expend a Wild Shape use to awaken your spores for 10 minutes: gain temporary hit points equal to 4 × your druid level; Halo of Spores damage rolls twice; melee weapon hits deal +1d6 necrotic. Ends early if you lose the temp HP or Wild Shape again." },
            { level: 6, name: "Fungal Infestation", description: "At 6th level, if a Small or Medium beast or humanoid dies within 10 feet of you, you can use your reaction to animate it as a zombie (1 HP) for 1 hour. It acts after your turn, obeys mental commands, and can only take the Attack action (one melee attack). Uses equal to your Wisdom modifier (minimum 1) per long rest." },
            { level: 10, name: "Spreading Spores", description: "At 10th level, while Symbiotic Entity is active, as a bonus action you can hurl spores to a point within 30 feet, filling a 10-foot cube for 1 minute. Creatures that enter or start their turn there take your Halo of Spores damage (Constitution save negates), at most once per turn. While the cube lasts you can't use your Halo of Spores reaction. Ends early if you use the feature again, dismiss it, or Symbiotic Entity ends." },
            { level: 14, name: "Fungal Body", description: "At 14th level you can't be blinded, deafened, frightened, or poisoned, and any critical hit against you counts as a normal hit unless you are incapacitated." }
        ],
        stars: [
            { level: 2, name: "Star Map & Starry Form", description: "At 2nd level you create a Tiny star map that can be a druid spell focus. While holding it you know guidance, always have guiding bolt prepared (doesn't count against prepared spells), and can cast guiding bolt without a slot a number of times equal to your proficiency bonus per long rest. As a bonus action you can expend a Wild Shape use to assume a luminous Starry Form for 10 minutes (bright light 10 feet, dim 10 more). Choose Archer (bonus-action ranged spell attack within 60 feet dealing 1d8 + Wisdom mod radiant), Chalice (when you heal with a spell slot, you or another within 30 feet regain 1d8 + Wisdom mod), or Dragon (treat d20 rolls of 9 or lower as 10 on Intelligence or Wisdom checks and Constitution saves to maintain concentration)." },
            { level: 6, name: "Cosmic Omen", description: "At 6th level, after a long rest roll a die. Until your next long rest: even (Weal) — as a reaction when a creature you can see within 30 feet is about to make an attack, save, or check, roll a d6 and add it; odd (Woe) — same reaction but subtract the d6. Uses equal to your proficiency bonus per long rest." },
            { level: 10, name: "Twinkling Constellations", description: "At 10th level the Archer and Chalice dice become 2d8, and while Dragon is active you have a flying speed of 20 feet and can hover. At the start of each of your turns in Starry Form you can change which constellation is active." },
            { level: 14, name: "Full of Stars", description: "At 14th level, while in Starry Form you have resistance to bludgeoning, piercing, and slashing damage." }
        ],
        wildfire: [
            { level: 2, name: "Summon Wildfire Spirit", description: "At 2nd level you gain circle spells. As an action you can expend a Wild Shape use to summon a Wildfire Spirit in an unoccupied space within 30 feet. Creatures other than you within 10 feet when it appears take 2d6 fire damage (Dexterity save vs your spell save DC for none). The spirit is a Small elemental (AC 13; HP 5 + five × your druid level; speed 30 ft., fly 30 ft. hover; immune to fire and several conditions; Flame Seed and Fiery Teleportation using your spell attack/save DC). It shares your initiative (acts after you), Dodges unless you command it as a bonus action, and lasts 1 hour, until reduced to 0 HP, resummoned, or you die." },
            { level: 6, name: "Enhanced Bond", description: "At 6th level, while your Wildfire Spirit is summoned, whenever you cast a spell that deals fire damage or restores hit points, roll a d8 and add it to one damage or healing roll of that spell. Spells with a range other than self can also originate from the spirit's space." },
            { level: 10, name: "Cauterizing Flames", description: "At 10th level, when a Small or larger creature dies within 30 feet of you or your spirit, a spectral flame appears in its space for 1 minute. When a creature you can see enters that space, you can use your reaction to extinguish it and either heal the creature or deal fire damage equal to 2d10 + your Wisdom modifier. Uses equal to your proficiency bonus per long rest." },
            { level: 14, name: "Blazing Revival", description: "At 14th level, if you drop to 0 hit points while your Wildfire Spirit is within 120 feet, you can cause the spirit to drop to 0 instead; you then regain half your hit points and stand up. Once per long rest." }
        ]
    },
    fighter: {
        champion: [
            { level: 3, name: "Improved Critical", description: "Beginning at 3rd level, your weapon attacks score a critical hit on a roll of 19 or 20." },
            { level: 7, name: "Remarkable Athlete", description: "Starting at 7th level, add half your proficiency bonus (rounded up) to any Strength, Dexterity, or Constitution check that does not already use your proficiency bonus. When you make a running long jump, the distance you can cover increases by a number of feet equal to your Strength modifier." },
            { level: 10, name: "Additional Fighting Style", description: "At 10th level, choose a second option from the Fighting Style class feature." },
            ...
            { level: 18, name: "Survivor", description: "At 18th level, at the start of each of your turns you regain hit points equal to 5 + your Constitution modifier if you have no more than half your hit points left and at least 1 hit point. You gain nothing from this feature while you have 0 hit points." }
        ],
        "battle-master": [
            { level: 3, name: "Combat Superiority", description: "At 3rd level you learn three maneuvers of your choice, fueled by superiority dice. You have four superiority dice (d8s); expend one when you use a maneuver, and regain all on a short or long rest. You gain another die at 7th and again at 15th level, and learn two more maneuvers at 7th, 10th, and 15th (you may replace one known maneuver each time you learn new ones). Only one maneuver per attack. Maneuver save DC = 8 + your proficiency bonus + your Strength or Dexterity modifier (your choice). Examples include Trip Attack, Riposte, Disarming Attack, Precision Attack, and Commander's Strike. You also gain Student of War: proficiency with one type of artisan's tools of your choice." },
            { level: 7, name: "Know Your Enemy", description: "Starting at 7th level, if you spend at least 1 minute observing or interacting with a creature outside combat, the DM tells you whether it is your equal, superior, or inferior in two characteristics you choose from: Strength, Dexterity, Constitution, Armor Class, current hit points, total class levels (if any), or fighter class levels (if any)." },
            { level: 10, name: "Improved Combat Superiority", description: "At 10th level, your superiority dice become d10s." },
            { level: 15, name: "Relentless", description: "Starting at 15th level, when you roll initiative and have no superiority dice remaining, you regain one superiority die." },
            { level: 18, name: "Improved Combat Superiority (d12)", description: "At 18th level, your superiority dice become d12s." }
        ],
        "eldritch-knight": [
            { level: 3, name: "Spellcasting & Weapon Bond", description: "At 3rd level you learn wizard spellcasting (Intelligence): two cantrips, three 1st-level spells (at least two from abjuration or evocation), and spell slots per the Eldritch Knight table; most later spells must be abjuration or evocation, except those learned at 8th, 14th, and 20th which may be any school. Spell save DC = 8 + proficiency + Intelligence; spell attack = proficiency + Intelligence. You also perform a 1-hour ritual (can be during a short rest) to bond with a weapon: you cannot be disarmed of it unless incapacitated, and as a bonus action you can summon it to your hand if it is on the same plane. You can bond up to two weapons (summon one per bonus action); bonding a third breaks one existing bond." },
            ...
            { level: 10, name: "Eldritch Strike", description: "At 10th level, when you hit a creature with a weapon attack, that creature has disadvantage on the next saving throw it makes against a spell you cast before the end of your next turn." },
            { level: 15, name: "Arcane Charge", description: "At 15th level, when you use Action Surge you can teleport up to 30 feet to an unoccupied space you can see, before or after the additional action." },
        ...
        "purple-dragon-knight": [
            { level: 3, name: "Rallying Cry", description: "When you choose this archetype at 3rd level, whenever you use Second Wind you can choose up to three allies within 60 feet that can see or hear you. Each regains hit points equal to your fighter level." },
            { level: 7, name: "Royal Envoy", description: "At 7th level you gain proficiency in Persuasion (or, if already proficient, choose Animal Handling, Insight, Intimidation, or Performance instead). Your proficiency bonus is doubled for any ability check that uses Persuasion, whether or not Persuasion was the skill you gained from this feature." },
            { level: 10, name: "Inspiring Surge", description: "Starting at 10th level, when you use Action Surge you can choose one ally within 60 feet that can see or hear you. That creature can use its reaction to make one melee or ranged weapon attack." },
            { level: 15, name: "Bulwark", description: "Beginning at 15th level, when you use Indomitable to reroll an Intelligence, Wisdom, or Charisma saving throw and you are not incapacitated, you can choose one ally within 60 feet that also failed its save against the same effect. If that creature can see or hear you, it can reroll its saving throw and must use the new roll." },
            { level: 18, name: "Inspiring Surge (two allies)", description: "At 18th level, when you use Inspiring Surge you can grant the extra weapon attack to two allies within 60 feet instead of one." }
        ],
        "arcane-archer": [
            { level: 3, name: "Arcane Archer Lore & Arcane Shot", description: "At 3rd level choose proficiency in Arcana or Nature, and learn prestidigitation or druidcraft. You also learn two Arcane Shot options. Once per turn when you fire a magic arrow from a shortbow or longbow as part of the Attack action, you can apply one option (usually when the arrow hits, unless the option does not use an attack roll). You have two uses, regained on a short or long rest. Save DC = 8 + proficiency + Intelligence. You learn additional options at 7th, 10th, 15th, and 18th. Options include Banishing Arrow, Beguiling Arrow (extra 2d6 psychic), Bursting Arrow (2d6 force in 10 feet), Enfeebling Arrow, Grasping Arrow, Piercing Arrow (30-foot line), Seeking Arrow, and Shadow Arrow." },
            { level: 7, name: "Curving Shot & Magic Arrow", description: "At 7th level, whenever you fire a nonmagical arrow from a shortbow or longbow you can make it magical for overcoming resistance and immunity to nonmagical attacks and damage (the magic fades after it hits or misses). Also, when you miss with an attack roll using a magic arrow, you can use a bonus action to reroll the attack against a different target within 60 feet of the original target. You also learn a third Arcane Shot option." },
            { level: 15, name: "Ever-Ready Shot", description: "Starting at 15th level, when you roll initiative and have no uses of Arcane Shot remaining, you regain one use. You also learn a fifth Arcane Shot option." },
            { level: 18, name: "Improved Shots", description: "At 18th level you learn a sixth Arcane Shot option, and your Arcane Shot options improve: many that deal extra damage increase (typically from 2d6 to 4d6, or from 1d6 to 2d6 for Piercing and Seeking Arrow), and Banishing Arrow also deals 2d6 force on a hit." }
        ],
        cavalier: [
            { level: 3, name: "Bonus Proficiency, Born to the Saddle & Unwavering Mark", description: "At 3rd level gain proficiency in Animal Handling, History, Insight, Performance, or Persuasion, or learn one language. Born to the Saddle: advantage on saves to avoid falling off your mount; if you fall no more than 10 feet you land on your feet if not incapacitated; mounting or dismounting costs only 5 feet of movement. Unwavering Mark: when you hit a creature with a melee weapon attack you can mark it until the end of your next turn (ends early if you are incapacitated or die, or if another mark is applied). While within 5 feet of you, the marked creature has disadvantage on attack rolls that do not target you. If it damages anyone other than you, as a bonus action on your next turn you can make a special melee weapon attack against it with advantage, dealing extra damage equal to half your fighter level on a hit. You can make this special attack a number of times equal to your Strength modifier (minimum once) per long rest." },
            { level: 7, name: "Warding Maneuver", description: "At 7th level, when you or a creature you can see within 5 feet is hit by an attack, if you are wielding a melee weapon or a shield you can use your reaction to roll 1d8 and add it to the target's AC against that attack. If the attack still hits, the target has resistance to the attack's damage. Uses equal to your Constitution modifier (minimum once) per long rest." },
            { level: 10, name: "Hold the Line", description: "At 10th level, creatures provoke an opportunity attack from you when they move 5 feet or more while within your reach. If you hit a creature with an opportunity attack, its speed becomes 0 until the end of the current turn." },
            { level: 15, name: "Ferocious Charger", description: "Starting at 15th level, once on each of your turns if you move at least 10 feet in a straight line immediately before hitting a creature with an attack, the target must succeed on a Strength save (DC 8 + proficiency + Strength) or be knocked prone." },
            { level: 18, name: "Vigilant Defender", description: "Starting at 18th level, in combat you gain a special reaction you can take once on every creature's turn except your own, usable only to make an opportunity attack. You cannot use it on the same turn you take your normal reaction." }
        ],
        samurai: [
            { level: 3, name: "Bonus Proficiency & Fighting Spirit", description: "At 3rd level gain proficiency in History, Insight, Performance, or Persuasion, or learn one language. As a bonus action, Fighting Spirit gives you advantage on weapon attack rolls until the end of the current turn and 5 temporary hit points (10 at 10th level, 15 at 15th). Three uses per long rest." },
            { level: 7, name: "Elegant Courtier", description: "Starting at 7th level, add your Wisdom modifier to Charisma (Persuasion) checks. You also gain proficiency in Wisdom saving throws, or if you already have it, proficiency in Intelligence or Charisma saves (your choice)." },
            { level: 10, name: "Tireless Spirit", description: "Starting at 10th level, when you roll initiative and have no uses of Fighting Spirit remaining, you regain one use. Your Fighting Spirit temporary hit points also increase to 10." },
            { level: 15, name: "Rapid Strike", description: "Starting at 15th level, once per turn when you take the Attack action and have advantage on a weapon attack roll against one of the targets, you can forgo that advantage to make one additional weapon attack against that target as part of the same action. Fighting Spirit temporary hit points increase to 15." },
            { level: 18, name: "Strength Before Death", description: "Starting at 18th level, if damage reduces you to 0 hit points and does not kill you outright, you can use your reaction to delay falling unconscious and immediately take an extra turn, interrupting the current turn. While you have 0 hit points during that extra turn, taking damage causes death saving throw failures as normal. When the extra turn ends, you fall unconscious if you still have 0 hit points. Once per long rest." }
        ],
        "psi-warrior": [
            { level: 3, name: "Psionic Power", description: "At 3rd level you gain Psionic Energy dice (d6; number = twice your proficiency bonus), regained on a long rest; as a bonus action once per short or long rest you can regain one expended die. Die size increases at 5th (d8), 11th (d10), and 17th (d12). Protective Field (reaction): when you or a creature you can see within 30 feet takes damage, expend a die to reduce the damage by the roll + your Intelligence modifier (minimum 1). Psionic Strike: once on each of your turns after you hit a target within 30 feet with a weapon and deal damage, expend a die to deal force damage equal to the roll + Intelligence. Telekinetic Movement (action): move one Large or smaller loose object or willing creature (not yourself) you can see within 30 feet up to 30 feet to an unoccupied space, or move a Tiny object to or from your hand; once per short or long rest, or again by expending a die." },
            { level: 7, name: "Telekinetic Adept", description: "At 7th level you gain Psi-Powered Leap: as a bonus action gain a flying speed equal to twice your walking speed until the end of the current turn (once per short or long rest, or again by expending a Psionic Energy die). Telekinetic Thrust: when you deal Psionic Strike damage, you can force the target to make a Strength save (DC 8 + proficiency + Intelligence); on a failure knock it prone or move it up to 10 feet horizontally." },
            { level: 10, name: "Guarded Mind", description: "At 10th level you gain resistance to psychic damage. If you start your turn charmed or frightened, you can expend a Psionic Energy die to end every effect on yourself subjecting you to those conditions." },
            { level: 15, name: "Bulwark of Force", description: "At 15th level, as a bonus action choose creatures you can see within 30 feet (including yourself), up to your Intelligence modifier (minimum 1). Each has half cover for 1 minute or until you are incapacitated. Once per long rest, or again by expending a Psionic Energy die." },
            { level: 18, name: "Telekinetic Master", description: "At 18th level you can cast telekinesis without components (Intelligence is your spellcasting ability). On each of your turns while you concentrate on it, including the turn you cast it, you can make one weapon attack as a bonus action. Once per long rest, or again by expending a Psionic Energy die." }
        ],
        "rune-knight": [
            { level: 3, name: "Bonus Proficiencies, Rune Carver & Giant's Might", description: "At 3rd level gain proficiency with smith's tools and learn to speak, read, and write Giant. Rune Carver: learn two runes (more at higher levels; DC 8 + proficiency + Constitution). After a long rest, inscribe each known rune on a different eligible object (weapon, armor, shield, jewelry, or something you wear or hold); each rune grants a passive benefit and an invoke effect usable once per short or long rest (examples: Cloud, Fire, Frost, Stone; Hill and Storm from 7th). Giant's Might (bonus action, proficiency bonus times per long rest): for 1 minute become Large if you have room (with worn gear), gain advantage on Strength checks and saves, and once per turn deal an extra 1d6 damage with a weapon or unarmed strike on a hit." },
            { level: 7, name: "Runic Shield", description: "At 7th level, when another creature you can see within 60 feet is hit by an attack, you can use your reaction to force the attacker to reroll the d20 and use the new roll. Uses equal to your proficiency bonus per long rest. You also learn a third rune." },
            { level: 10, name: "Great Stature", description: "At 10th level you permanently grow 3d4 inches taller, and the extra damage from Giant's Might increases to 1d8. You also learn a fourth rune." },
            { level: 15, name: "Master of Runes", description: "At 15th level you can invoke each rune you know twice per short or long rest instead of once, and you learn a fifth rune." },
            { level: 18, name: "Runic Juggernaut", description: "At 18th level the extra damage from Giant's Might increases to 1d10. When you use Giant's Might your size can become Huge, and while Huge your reach increases by 5 feet." }
        ],
        "echo-knight": [
            { level: 3, name: "Manifest Echo", description: "As a bonus action you manifest a translucent gray echo in an unoccupied space you can see within 15 feet. It lasts until destroyed, dismissed (bonus action), replaced, or you are incapacitated. AC 14 + your proficiency bonus, 1 hit point, immunity to all conditions; it uses your saving throw bonuses, matches your size, and occupies its space. On your turn you can mentally move it up to 30 feet (no action); it is destroyed if more than 30 feet from you at the end of your turn. As a bonus action you can swap places with it for 15 feet of movement. Attacks from your Attack action can originate from your space or the echo's (choose per attack). When a creature you can see within 5 feet of the echo moves at least 5 feet away from it, you can use your reaction to make an opportunity attack as if you were in the echo's space." },
            { level: 7, name: "Unleash Incarnation", description: "Whenever you take the Attack action, you can make one additional melee attack from your echo's position. Uses equal to your Constitution modifier (minimum once) per long rest." },
            { level: 10, name: "Echo Avatar", description: "As an action you can see through your echo's eyes and hear through its ears for up to 10 minutes (you are blinded and deafened; end anytime, no action). While used this way, the echo can be up to 1,000 feet away without being destroyed." },
            { level: 15, name: "Shadow Martyr", description: "Before an attack roll is made against a creature you can see, you can use your reaction to teleport your echo to an unoccupied space within 5 feet of that creature; the attack is made against the echo instead. Once per short or long rest." },
            { level: 18, name: "Reclaim Potential", description: "When an echo of yours is destroyed by taking damage, if you do not already have temporary hit points you can gain temporary hit points equal to 2d6 + your Constitution modifier. Uses equal to your Constitution modifier (minimum once) per long rest." }
        ]
    },
    monk: {
        "open-hand": [
            { level: 3, name: "Open Hand Technique", description: "Starting at 3rd level, whenever you hit a creature with one of the attacks granted by Flurry of Blows, you can impose one of the following effects: it must succeed on a Dexterity save or be knocked prone; it must make a Strength save or be pushed up to 15 feet away from you; or it cannot take reactions until the end of your next turn." },
            { level: 6, name: "Wholeness of Body", description: "At 6th level, as an action you regain hit points equal to three times your monk level. Once per long rest." },
            { level: 11, name: "Tranquility", description: "Beginning at 11th level, at the end of a long rest you gain the effect of a sanctuary spell that lasts until the start of your next long rest (it can end early as normal). The save DC equals 8 + your Wisdom modifier + your proficiency bonus." },
            { level: 17, name: "Quivering Palm", description: "At 17th level, when you hit a creature with an unarmed strike you can spend 3 ki points to start imperceptible vibrations lasting a number of days equal to your monk level. As an action (you and the target on the same plane), end the vibrations: the creature makes a Constitution save; on a failure it is reduced to 0 hit points, on a success it takes 10d10 necrotic damage. Only one creature at a time; you can end the vibrations harmlessly without an action." }
        ],
        shadow: [
            { level: 3, name: "Shadow Arts", description: "Starting at 3rd level, as an action you can spend 2 ki points to cast darkness, darkvision, pass without trace, or silence without material components. You also learn the minor illusion cantrip if you do not already know it." },
            { level: 6, name: "Shadow Step", description: "At 6th level, when you are in dim light or darkness, as a bonus action you can teleport up to 60 feet to an unoccupied space you can see that is also in dim light or darkness. You then have advantage on the first melee attack you make before the end of the turn." },
            { level: 11, name: "Cloak of Shadows", description: "By 11th level, when you are in dim light or darkness you can use your action to become invisible. You remain invisible until you make an attack, cast a spell, or are in an area of bright light." },
            { level: 17, name: "Opportunist", description: "At 17th level, whenever a creature within 5 feet of you is hit by an attack made by a creature other than you, you can use your reaction to make a melee attack against that creature." }
        ],
        "four-elements": [
            { level: 3, name: "Disciple of the Elements", description: "At 3rd level you know Elemental Attunement and one other elemental discipline. Disciplines cost ki; some let you cast spells without material components. From 5th level you can spend extra ki to cast a discipline spell at higher level (each extra point raises the spell level by 1), up to a maximum total ki spent based on your monk level (3 at 5th-8th, 4 at 9th-12th, 5 at 13th-16th, 6 at 17th-20th). Sample disciplines include Fangs of the Fire Snake, Water Whip, Fist of Unbroken Air, Sweeping Cinder Strike (burning hands), and Fist of Four Thunders (thunderwave)." },
            { level: 6, name: "Additional Elemental Discipline", description: "At 6th level you learn one additional elemental discipline of your choice, and may replace one you already know. New options available at this tier include Clench of the North Wind (hold person for 3 ki) and Gong of the Summit (shatter for 3 ki)." },
            { level: 11, name: "Additional Elemental Discipline", description: "At 11th level you learn another elemental discipline and may replace one known. Options unlocked at this tier include Flames of the Phoenix (fireball for 4 ki), Mist Stance (gaseous form for 4 ki), and Ride the Wind (fly for 4 ki)." },
            { level: 17, name: "Additional Elemental Discipline", description: "At 17th level you learn another elemental discipline and may replace one known. The most powerful options include Breath of Winter (cone of cold for 6 ki), Eternal Mountain Defense (stoneskin for 5 ki), River of Hungry Flame (wall of fire for 5 ki), and Wave of Rolling Earth (wall of stone for 6 ki)." }
        ],
        "long-death": [
            { level: 3, name: "Touch of Death", description: "Starting at 3rd level, when you reduce a creature within 5 feet of you to 0 hit points, you gain temporary hit points equal to your Wisdom modifier + your monk level (minimum 1)." },
            { level: 6, name: "Hour of Reaping", description: "At 6th level, as an action each creature within 30 feet of you that can see you must succeed on a Wisdom saving throw or be frightened of you until the end of your next turn." },
            { level: 11, name: "Mastery of Death", description: "Beginning at 11th level, when you are reduced to 0 hit points you can expend 1 ki point (no action required) to have 1 hit point instead." },
            { level: 17, name: "Touch of the Long Death", description: "Starting at 17th level, as an action you touch one creature within 5 feet and expend 1 to 10 ki points. The target makes a Constitution save, taking 2d10 necrotic damage per ki point spent on a failure, or half as much on a success." }
        ],
        "sun-soul": [
            { level: 3, name: "Radiant Sun Bolt", description: "Starting at 3rd level you gain a special Attack-action option: a ranged spell attack with 30-foot range. You are proficient, add Dexterity to attack and damage, deal radiant damage, and use a d4 that scales with your Martial Arts die. When you take the Attack action and use this special attack as part of it, you can spend 1 ki point to make the special attack twice as a bonus action. Once you have Extra Attack, you can use this special attack for any of the attacks from the Attack action." },
            { level: 6, name: "Searing Arc Strike", description: "At 6th level, immediately after you take the Attack action on your turn, you can spend 2 ki points to cast burning hands as a bonus action. You can spend additional ki to cast it at higher levels (each extra point raises the level by 1). The maximum ki you can spend (including the base 2) equals half your monk level (rounded down)." },
            { level: 11, name: "Searing Sunburst", description: "At 11th level, as an action create an orb and hurl it to a point within 150 feet, erupting in a 20-foot-radius sphere. Each creature in the sphere must succeed on a Constitution save or take 2d6 radiant damage (creatures behind opaque total cover need not save). You can spend up to 3 ki points; each point spent increases the damage by 2d6." },
            { level: 17, name: "Sun Shield", description: "At 17th level you shed bright light in a 30-foot radius and dim light for an additional 30 feet; extinguish or restore the light as a bonus action. While the light shines, when a creature hits you with a melee attack you can use your reaction to deal radiant damage equal to 5 + your Wisdom modifier." }
        ],
        "drunken-master": [
            { level: 3, name: "Bonus Proficiencies & Drunken Technique", description: "At 3rd level you gain proficiency in Performance and with brewer's supplies if you do not already have them. Whenever you use Flurry of Blows, you also gain the benefit of the Disengage action, and your walking speed increases by 10 feet until the end of the current turn." },
            { level: 6, name: "Tipsy Sway", description: "Starting at 6th level: Leap to Your Feet — when you are prone, standing up costs only 5 feet of movement. Redirect Attack — when a creature misses you with a melee attack roll, you can spend 1 ki point as a reaction to cause that attack to hit one other creature of your choice that you can see within 5 feet of you (not the attacker)." },
            { level: 11, name: "Drunkard's Luck", description: "Starting at 11th level, when you make an ability check, attack roll, or saving throw with disadvantage, you can spend 2 ki points to cancel the disadvantage for that roll." },
            { level: 17, name: "Intoxicated Frenzy", description: "At 17th level, when you use Flurry of Blows you can make up to three additional attacks with it (up to five Flurry attacks total), provided each Flurry of Blows attack targets a different creature this turn." }
        ],
        kensei: [
            { level: 3, name: "Path of the Kensei", description: "At 3rd level choose two weapon types as kensei weapons (one melee, one ranged): any simple or martial weapon lacking the heavy and special properties, or a longbow. You gain proficiency with them if needed, and they count as monk weapons. At 6th, 11th, and 17th you can choose another type. Agile Parry: if you make an unarmed strike as part of the Attack action while holding a melee kensei weapon, gain +2 AC until the start of your next turn while the weapon is in hand and you are not incapacitated. Kensei's Shot (bonus action): until the end of the current turn, any target you hit with a ranged kensei weapon attack takes an extra 1d4 damage of the weapon's type. Way of the Brush: proficiency with calligrapher's supplies or painter's supplies." },
            { level: 6, name: "One with the Blade", description: "At 6th level your attacks with kensei weapons count as magical for overcoming resistance and immunity to nonmagical attacks and damage. Deft Strike: once on each of your turns when you hit with a kensei weapon, you can spend 1 ki point to deal extra damage equal to your Martial Arts die." },
            { level: 11, name: "Sharpen the Blade", description: "At 11th level, as a bonus action expend up to 3 ki points to grant one kensei weapon you touch a bonus to attack and damage rolls equal to the ki spent for 1 minute or until you use this feature again. Has no effect on a magic weapon that already has a bonus to attack and damage." },
            { level: 17, name: "Unerring Accuracy", description: "At 17th level, once on each of your turns if you miss with an attack roll using a monk weapon, you can reroll it." }
        ],
        mercy: [
            { level: 3, name: "Implements of Mercy, Hand of Healing & Hand of Harm", description: "At 3rd level gain proficiency in Insight and Medicine and with the herbalism kit, plus a special mask of your design. Hand of Healing (action, 1 ki): touch a creature and restore hit points equal to one Martial Arts die + your Wisdom modifier; when you use Flurry of Blows you can replace one unarmed strike with this healing without spending the ki for healing. Hand of Harm: once per turn when you hit with an unarmed strike, spend 1 ki to deal extra necrotic damage equal to one Martial Arts die + Wisdom." },
            { level: 6, name: "Physician's Touch", description: "At 6th level, when you use Hand of Healing you can also end one disease or one of the following conditions: blinded, deafened, paralyzed, poisoned, or stunned. When you use Hand of Harm you can also poison the target until the end of your next turn." },
            { level: 11, name: "Flurry of Healing and Harm", description: "At 11th level, when you use Flurry of Blows you can replace each unarmed strike with Hand of Healing without spending ki for the healing. In addition, when you make an unarmed strike with Flurry of Blows you can use Hand of Harm with that strike without spending the ki for Hand of Harm (still only once per turn)." },
            { level: 17, name: "Hand of Ultimate Mercy", description: "At 17th level, as an action touch the corpse of a creature that died within the past 24 hours and expend 5 ki points. It returns to life with hit points equal to 4d10 + your Wisdom modifier, and if it died while blinded, deafened, paralyzed, poisoned, or stunned those conditions are removed. Once per long rest." }
        ],
        "astral-self": [
            { level: 3, name: "Arms of the Astral Self", description: "As a bonus action spend 1 ki to summon spectral arms for 10 minutes (vanish early if you are incapacitated or die). When you summon them, each creature of your choice within 10 feet that you can see must succeed on a Dexterity save or take force damage equal to two Martial Arts dice. While present: use Wisdom instead of Strength for Strength checks and saves; make unarmed strikes with the arms (+5 feet reach on your turn); those strikes can use Wisdom for attack and damage and deal force damage." },
            { level: 6, name: "Visage of the Astral Self", description: "As a bonus action (or as part of the bonus action to summon Arms), spend 1 ki to summon a spectral visage for 10 minutes. While present: see normally in magical and nonmagical darkness to 120 feet; advantage on Wisdom (Insight) and Charisma (Intimidation) checks; when you speak you can make only one chosen creature within 60 feet hear you, or amplify your voice so all creatures within 600 feet can hear you." },
            { level: 11, name: "Body of the Astral Self", description: "When both your astral arms and visage are summoned, you can cause the spectral body to appear (no action). While present: Deflect Energy — when you take acid, cold, fire, force, lightning, or thunder damage, use your reaction to reduce it by 1d10 + Wisdom (minimum 1); Empowered Arms — once on each of your turns when you hit with Arms of the Astral Self, deal extra damage equal to your Martial Arts die." },
            { level: 17, name: "Awakened Astral Self", description: "As a bonus action spend 5 ki to summon arms, visage, and body and awaken your astral self for 10 minutes. While awakened: +2 bonus to AC; whenever you use Extra Attack to attack twice, you can instead attack three times if all attacks are made with your astral arms." }
        ],
        "ascendant-dragon": [
            { level: 3, name: "Draconic Disciple & Breath of the Dragon", description: "At 3rd level your unarmed strikes can deal acid, cold, fire, lightning, or poison damage (your choice when you hit) instead of their normal type, and they count as magical for overcoming resistance and immunity to nonmagical attacks and damage. You learn to speak, read, and write Draconic, and when you make a Charisma (Intimidation) or Charisma (Persuasion) check you can treat a d20 roll of 9 or lower as a 10. Breath of the Dragon: when you take the Attack action, replace one attack with a 20-foot cone or 30-foot line (5 feet wide) of your chosen damage type; each creature in the area makes a Dexterity save (DC 8 + proficiency + Wisdom), taking Martial Arts die + Wisdom modifier damage on a failure or half on a success. Uses equal to your proficiency bonus per long rest, or spend 2 ki to use it again." },
            { level: 6, name: "Wings Unfurled", description: "At 6th level, when you use Step of the Wind you can unfurl spectral wings that grant a flying speed equal to your walking speed until the end of the turn. You can use these wings a number of times equal to your proficiency bonus per long rest." },
            { level: 11, name: "Aspect of the Wyrm", description: "At 11th level, as a bonus action create a 10-foot aura for 1 minute (30 feet at 17th). Choose Frightful Presence (creatures of your choice that start their turn in the aura must succeed on a Wisdom save or be frightened of you until the end of your next turn) or Resistance (you and allies in the aura have resistance to your Breath damage type). Uses equal to your proficiency bonus per long rest, or spend 3 ki to use it again." },
            { level: 17, name: "Ascendant Aspect", description: "At 17th level you gain blindsight out to 10 feet. When you use Aspect of the Wyrm you gain both aura options at once, and each creature of your choice that enters the aura for the first time on a turn or starts its turn there takes damage of your Breath type equal to one Martial Arts die (once per turn per creature). When you use Breath of the Dragon you can spend 1 ki to change the area to a 60-foot line or 30-foot cone and deal extra damage equal to one Martial Arts die to creatures that fail the save." }
        ]
    },
    paladin: {
        devotion: [
            { level: 3, name: "Channel Divinity: Sacred Weapon & Turn the Unholy", description: "At 3rd level you gain two Channel Divinity options. Sacred Weapon (action): for 1 minute add your Charisma modifier to attack rolls with one weapon you are holding (minimum +1); it sheds bright light in a 20-foot radius and dim light 20 feet beyond, and becomes magical for the duration if it was not. Ends if you stop holding it or fall unconscious. Turn the Unholy (action): each fiend or undead that can see or hear you within 30 feet must make a Wisdom save or be turned for 1 minute or until it takes damage (must Dash away, cannot willingly move within 30 feet of you, no reactions)." },
            { level: 7, name: "Aura of Devotion", description: "Starting at 7th level, you and friendly creatures within 10 feet of you cannot be charmed while you are conscious. At 18th level the range increases to 30 feet." },
            ...
            { level: 20, name: "Holy Nimbus", description: "At 20th level, as an action emanate sunlight for 1 minute: bright light in a 30-foot radius and dim light 30 feet beyond. Enemy creatures that start their turn in the bright light take 10 radiant damage. For the duration you have advantage on saving throws against spells cast by fiends or undead. Once per long rest." }
        ],
        ancients: [
            { level: 3, name: "Channel Divinity: Nature's Wrath & Turn the Faithless", description: "At 3rd level you gain two Channel Divinity options. Nature's Wrath (action): spectral vines restrain a creature you can see within 10 feet unless it succeeds on a Strength or Dexterity save (its choice); while restrained it repeats the save at the end of each of its turns, freeing itself on a success. Turn the Faithless (action): each fey or fiend within 30 feet that can hear you must make a Wisdom save or be turned for 1 minute or until it takes damage; while turned, any illusion, shapeshifting, or other effect concealing its true form is revealed." },
            { level: 7, name: "Aura of Warding", description: "Beginning at 7th level, you and friendly creatures within 10 feet of you have resistance to damage from spells. At 18th level the range increases to 30 feet." },
            { level: 15, name: "Undying Sentinel", description: "Starting at 15th level, when you are reduced to 0 hit points and are not killed outright, you can drop to 1 hit point instead (once per long rest). You also suffer none of the drawbacks of old age and cannot be aged magically." },
            { level: 20, name: "Elder Champion", description: "At 20th level, as an action transform for 1 minute: regain 10 hit points at the start of each of your turns; cast paladin spells with a casting time of 1 action as a bonus action instead; enemy creatures within 10 feet have disadvantage on saves against your paladin spells and Channel Divinity options. Once per long rest." }
        ],
        vengeance: [
            { level: 3, name: "Channel Divinity: Abjure Enemy & Vow of Enmity", description: "At 3rd level you gain two Channel Divinity options. Abjure Enemy (action): one creature you can see within 60 feet makes a Wisdom save (fiends and undead have disadvantage; immune creatures are unaffected). On a failure it is frightened for 1 minute or until it takes damage, with speed 0 and no bonuses to speed; on a success its speed is halved for 1 minute or until it takes damage. Vow of Enmity (bonus action): gain advantage on attack rolls against one creature you can see within 10 feet for 1 minute or until it drops to 0 hit points or falls unconscious." },
            { level: 7, name: "Relentless Avenger", description: "By 7th level, when you hit a creature with an opportunity attack you can move up to half your speed immediately afterward as part of the same reaction. This movement does not provoke opportunity attacks." },
            { level: 15, name: "Soul of Vengeance", description: "Starting at 15th level, when a creature under your Vow of Enmity makes an attack, you can use your reaction to make a melee weapon attack against it if it is within range." },
            { level: 20, name: "Avenging Angel", description: "At 20th level, as an action transform for 1 hour: gain a flying speed of 60 feet, and emanate a 30-foot aura of menace. The first time each battle an enemy enters the aura or starts its turn there, it must succeed on a Wisdom save or become frightened of you for 1 minute or until it takes damage; attack rolls against the frightened creature have advantage. Once per long rest." }
        ],
        oathbreaker: [
            { level: 3, name: "Channel Divinity: Control Undead & Dreadful Aspect", description: "At 3rd level you gain two Channel Divinity options. Control Undead (action): one undead you can see within 30 feet must make a Wisdom save or obey your commands for 24 hours (or until you use this option again); undead with CR equal to or greater than your paladin level are immune. Dreadful Aspect (action): each creature of your choice within 30 feet that can see you must make a Wisdom save or be frightened of you for 1 minute; a frightened creature that ends its turn more than 30 feet from you can repeat the save to end the effect." },
            { level: 7, name: "Aura of Hate", description: "Starting at 7th level, you and any fiends and undead within 10 feet of you gain a bonus to melee weapon damage rolls equal to your Charisma modifier (minimum +1). A creature can benefit from only one such aura at a time. At 18th level the range increases to 30 feet." },
            { level: 15, name: "Supernatural Resistance", description: "At 15th level you gain resistance to bludgeoning, piercing, and slashing damage from nonmagical weapons." },
            { level: 20, name: "Dread Lord", description: "At 20th level, as an action surround yourself with gloom for 1 minute: bright light within 30 feet becomes dim light; enemies frightened of you that start their turn in the aura take 4d10 psychic damage; you and creatures you choose in the aura are draped in deeper shadow, imposing disadvantage on attack rolls from creatures that rely on sight. As a bonus action while the aura lasts, make a melee spell attack against one creature; on a hit deal necrotic damage equal to 3d10 + your Charisma modifier. Once per long rest." }
        ],
        crown: [
            { level: 3, name: "Channel Divinity: Champion Challenge & Turn the Tide", description: "At 3rd level you gain two Channel Divinity options. Champion Challenge: each creature of your choice that you can see within 30 feet must make a Wisdom save or be unable to willingly move more than 30 feet away from you (ends if you are incapacitated or die, or if the creature is moved more than 30 feet away). Turn the Tide (bonus action): each creature of your choice that can hear you within 30 feet regains hit points equal to 1d6 + your Charisma modifier (minimum 1) if it has no more than half its hit points." },
            { level: 7, name: "Divine Allegiance", description: "Starting at 7th level, when a creature within 5 feet of you takes damage, you can use your reaction to magically take that damage instead. The damage to you cannot be reduced or prevented in any way." },
            { level: 15, name: "Unyielding Spirit", description: "Starting at 15th level, you have advantage on saving throws to avoid becoming paralyzed or stunned." },
            { level: 20, name: "Exalted Champion", description: "At 20th level, as an action for 1 hour: gain resistance to bludgeoning, piercing, and slashing damage from nonmagical weapons; you and allies within 30 feet have advantage on Wisdom saving throws; allies within 30 feet have advantage on death saving throws. Ends early if you are incapacitated or die. Once per long rest." }
        ],
        conquest: [
            { level: 3, name: "Channel Divinity: Conquering Presence & Guided Strike", description: "At 3rd level you gain two Channel Divinity options. Conquering Presence (action): each creature of your choice that you can see within 30 feet must make a Wisdom save or become frightened of you for 1 minute; it can repeat the save at the end of each of its turns. Guided Strike: when you make an attack roll, after seeing the roll but before knowing the result, gain a +10 bonus to the roll." },
            { level: 7, name: "Aura of Conquest", description: "Starting at 7th level, while you are not incapacitated you emanate a 10-foot aura (30 feet at 18th). A creature frightened of you has its speed reduced to 0 while in the aura, and takes psychic damage equal to half your paladin level if it starts its turn there." },
            { level: 15, name: "Scornful Rebuke", description: "Starting at 15th level, whenever a creature hits you with an attack while you are not incapacitated, that creature takes psychic damage equal to your Charisma modifier (minimum 1)." },
            { level: 20, name: "Invincible Conqueror", description: "At 20th level, as an action for 1 minute: gain resistance to all damage; when you take the Attack action you can make one additional attack as part of that action; your melee weapon attacks score a critical hit on a roll of 19 or 20. Once per long rest." }
        ],
        redemption: [
            { level: 3, name: "Channel Divinity: Emissary of Peace & Rebuke the Violent", description: "At 3rd level you gain two Channel Divinity options. Emissary of Peace (bonus action): gain a +5 bonus to Charisma (Persuasion) checks for 10 minutes. Rebuke the Violent (reaction): immediately after an attacker within 30 feet deals damage with an attack against a creature other than you, force it to make a Wisdom save; on a failure it takes radiant damage equal to the damage it just dealt, or half as much on a success." },
            { level: 7, name: "Aura of the Guardian", description: "Starting at 7th level, when a creature within 10 feet of you takes damage, you can use your reaction to magically take that damage instead (other accompanying effects are not transferred, and this damage cannot be reduced). At 18th level the range increases to 30 feet." },
            { level: 15, name: "Protective Spirit", description: "Starting at 15th level, you regain hit points equal to 1d6 + half your paladin level if you end your turn in combat with fewer than half your hit points remaining and you are not incapacitated." },
            { level: 20, name: "Emissary of Redemption", description: "At 20th level you have resistance to all damage dealt by other creatures, and whenever a creature hits you with an attack it takes radiant damage equal to half the damage you take from the attack. If you attack a creature, cast a spell on it, or deal damage to it by any means other than this feature, neither benefit works against that creature until you finish a long rest." }
        ],
        glory: [
            { level: 3, name: "Channel Divinity: Peerless Athlete & Inspiring Smite", description: "At 3rd level you gain two Channel Divinity options. Peerless Athlete (bonus action): for 10 minutes gain advantage on Strength (Athletics) and Dexterity (Acrobatics) checks; double carrying, pushing, dragging, and lifting capacity; and increase long and high jump distance by 10 feet (extra distance costs movement as normal). Inspiring Smite: immediately after you deal damage with Divine Smite, as a bonus action distribute temporary hit points totaling 2d8 + your paladin level among creatures of your choice within 30 feet (including yourself)." },
            { level: 7, name: "Aura of Alacrity", description: "At 7th level your walking speed increases by 10 feet. If you are not incapacitated, any ally who starts their turn within 5 feet of you (10 feet at 18th level) gains +10 feet walking speed until the end of that turn." },
            { level: 15, name: "Glorious Defense", description: "At 15th level, when you or another creature you can see within 10 feet is hit by an attack, you can use your reaction to grant a bonus to the target's AC equal to your Charisma modifier (minimum +1) against that attack. If the attack then misses, you can make one weapon attack against the attacker as part of the reaction if it is within your weapon's range. Uses equal to your Charisma modifier (minimum once) per long rest." },
            { level: 20, name: "Living Legend", description: "At 20th level, as a bonus action for 1 minute: gain advantage on all Charisma checks; once on each of your turns when you miss with a weapon attack, cause that attack to hit instead; if you fail a saving throw, use your reaction to reroll it and must use the new roll. Once per long rest, or again by expending a 5th-level spell slot." }
        ],
        watchers: [
            { level: 3, name: "Channel Divinity: Watcher's Will & Abjure the Extraplanar", description: "At 3rd level you gain two Channel Divinity options. Watcher's Will (action): choose up to your Charisma modifier creatures you can see within 30 feet (minimum 1); for 1 minute you and the chosen creatures have advantage on Intelligence, Wisdom, and Charisma saving throws. Abjure the Extraplanar (action): each aberration, celestial, elemental, fey, or fiend within 30 feet that can hear you must make a Wisdom save or be turned for 1 minute or until it takes damage." },
            { level: 7, name: "Aura of the Sentinel", description: "At 7th level, while you are not incapacitated, when you and any creatures of your choice within 10 feet of you roll initiative, you all gain a bonus to initiative equal to your proficiency bonus. At 18th level the range increases to 30 feet." },
            { level: 15, name: "Vigilant Rebuke", description: "At 15th level, whenever you or a creature you can see within 30 feet succeeds on an Intelligence, Wisdom, or Charisma saving throw, you can use your reaction to deal 2d8 + your Charisma modifier force damage to the creature that forced the saving throw." },
            { level: 20, name: "Mortal Bulwark", description: "At 20th level, as a bonus action for 1 minute: gain truesight out to 120 feet; advantage on attack rolls against aberrations, celestials, elementals, fey, and fiends; when you hit a creature with an attack and deal damage, you can force it to make a Charisma save against your spell save DC — on a failure it is banished to its native plane if it is not already there; on a success it cannot be banished by this feature for 24 hours. Once per long rest, or again by expending a 5th-level spell slot." }
        ]
    },
    ranger: {
        hunter: [
            { level: 3, name: "Hunter's Prey", description: "At 3rd level choose one: Colossus Slayer — once per turn when you hit a creature below its hit point maximum with a weapon attack, it takes an extra 1d8 damage; Giant Killer — when a Large or larger creature within 5 feet that you can see hits or misses you, you can use your reaction to attack it immediately after; Horde Breaker — once on each of your turns when you make a weapon attack, you can make another attack with the same weapon against a different creature within 5 feet of the original target and within your weapon's range." },
            { level: 7, name: "Defensive Tactics", description: "At 7th level choose one: Escape the Horde — opportunity attacks against you have disadvantage; Multiattack Defense — when a creature hits you, you gain +4 AC against further attacks from that creature for the rest of the turn; Steel Will — advantage on saves against being frightened." },
            { level: 11, name: "Multiattack", description: "At 11th level choose one: Volley — as an action make a ranged attack against any number of creatures within 10 feet of a point you can see in your weapon's range (separate attack roll and ammunition per target); Whirlwind Attack — as an action make a melee attack against any number of creatures within 5 feet of you (separate attack roll each)." },
            { level: 15, name: "Superior Hunter's Defense", description: "At 15th level choose one: Evasion — on a Dexterity save for half damage you take none on a success and half on a failure; Stand Against the Tide — when a hostile creature misses you with a melee attack, you can use your reaction to force it to repeat the attack against another creature (not itself) of your choice; Uncanny Dodge — when an attacker you can see hits you, use your reaction to halve the attack's damage." }
        ],
        "beast-master": [
            { level: 3, name: "Ranger's Companion", description: "At 3rd level you gain a beast companion no larger than Medium and CR 1/4 or lower. Add your proficiency bonus to its AC, attacks, damage, and proficient saves/skills; its HP maximum is its stat block or four times your ranger level (whichever is higher). It shares your initiative; you can verbally direct its movement for free and use your action to command Attack, Dash, Disengage, or Help (Dodge if uncommanded). With Extra Attack you can make one weapon attack when commanding Attack. If it dies, spend 8 hours bonding with a new qualifying beast." },
            { level: 7, name: "Exceptional Training", description: "Beginning at 7th level, on a turn when your beast doesn't attack, you can use a bonus action to command it to Dash, Disengage, Dodge, or Help. Its attacks also count as magical for overcoming nonmagical resistance and immunity." },
            { level: 11, name: "Bestial Fury", description: "Starting at 11th level, when you command your beast to take the Attack action it can make two attacks, or take Multiattack if it has that action." },
            { level: 15, name: "Share Spells", description: "Beginning at 15th level, when you cast a spell targeting yourself, you can also affect your beast companion if it is within 30 feet of you." }
        ],
        "gloom-stalker": [
            { level: 3, name: "Dread Ambusher & Umbral Sight", description: "At 3rd level you gain gloom stalker spells. You add your Wisdom modifier to initiative. On your first turn of combat your walking speed increases by 10 feet, and if you take the Attack action you can make one additional weapon attack that deals an extra 1d8 damage of the weapon's type. You also gain darkvision out to 60 feet (or +30 feet if you already have it), and while in darkness you are invisible to any creature that relies on darkvision to see you in that darkness." },
            { level: 7, name: "Iron Mind", description: "At 7th level you gain proficiency in Wisdom saving throws. If you already have it, you instead gain proficiency in Intelligence or Charisma saving throws (your choice)." },
            { level: 11, name: "Stalker's Flurry", description: "At 11th level, once on each of your turns when you miss with a weapon attack, you can make another weapon attack as part of the same action." },
            { level: 15, name: "Shadowy Dodge", description: "At 15th level, when a creature makes an attack roll against you and doesn't have advantage, you can use your reaction to impose disadvantage on that roll. You must use this before knowing whether the attack hits or misses." }
        ],
        "horizon-walker": [
            { level: 3, name: "Detect Portal & Planar Warrior", description: "At 3rd level you gain horizon walker spells. As an action you can detect the distance and direction to the nearest planar portal within 1 mile (once per short or long rest). As a bonus action you can choose one creature you can see within 30 feet; until the end of the turn, your weapon attacks against it deal force damage instead of their normal type, and the first time you hit it on each of your turns it takes an extra 1d8 force damage (2d8 at 11th level)." },
            { level: 7, name: "Ethereal Step", description: "At 7th level, as a bonus action you can cast etherealness on yourself without a spell slot, but the spell ends at the end of the current turn. Once per short or long rest." },
            { level: 11, name: "Distant Strike", description: "At 11th level, when you take the Attack action you can teleport up to 10 feet before each attack to an unoccupied space you can see. If you attack at least two different creatures with that action, you can make one additional attack with it against a third creature." },
            { level: 15, name: "Spectral Defense", description: "At 15th level, when you take damage from an attack, you can use your reaction to give yourself resistance to all of that attack's damage on this turn." }
        ],
        "monster-slayer": [
            { level: 3, name: "Hunter's Sense & Slayer's Prey", description: "At 3rd level you gain monster slayer spells. As an action, choose a creature you can see within 60 feet; you learn whether it has any damage immunities, resistances, or vulnerabilities and what they are (once per short or long rest, or again by spending a spell slot of 1st level or higher). Also as a bonus action mark a creature you can see within 60 feet as your prey until you finish a short or long rest (or mark another); the first time each turn you hit it with a weapon attack, it takes an extra 1d6 damage of the weapon's type." },
            { level: 7, name: "Supernatural Defense", description: "At 7th level, whenever your Slayer's Prey target forces you to make a saving throw, or you make an ability check to escape its grapple, add 1d6 to your roll." },
            { level: 11, name: "Magic-User's Nemesis", description: "At 11th level, when you see a creature casting a spell or teleporting within 60 feet, you can use your reaction to force it to make a Wisdom save against your spell save DC. On a failure the teleport or spell fails and is wasted. Once per short or long rest." },
            { level: 15, name: "Slayer's Counter", description: "At 15th level, if your Slayer's Prey target forces you to make a saving throw, you can use your reaction to make one weapon attack against it. On a hit you automatically succeed on the saving throw." }
        ],
        "fey-wanderer": [
            { level: 3, name: "Dreadful Strikes & Otherworldly Glamour", description: "At 3rd level you gain fey wanderer spells. Once per turn when you hit a creature with a weapon attack, you can deal an extra 1d4 psychic damage (1d6 at 11th level). You also gain proficiency in Deception, Performance, or Persuasion, and whenever you make a Charisma check you gain a bonus equal to your Wisdom modifier (minimum +1)." },
            { level: 7, name: "Beguiling Twist", description: "At 7th level you have advantage on saves against being charmed or frightened. When a creature you can see within 120 feet succeeds on a save against being charmed or frightened, you can use your reaction to force a different creature you can see within 120 feet to make a Wisdom save against your spell save DC or be charmed or frightened by you (your choice) for 1 minute (repeat save at end of each of its turns)." },
            { level: 11, name: "Fey Reinforcements", description: "At 11th level you always have summon fey prepared. You can cast it once without a spell slot per long rest, and when you cast it with a spell slot you can modify it so it doesn't require concentration (duration still ends early as normal)." },
            { level: 15, name: "Misty Wanderer", description: "At 15th level you can cast misty step without a spell slot a number of times equal to your Wisdom modifier (minimum once) per long rest, and you can bring one willing creature within 5 feet along (it teleports to an unoccupied space of your choice within 5 feet of your destination)." }
        ],
        swarmkeeper: [
            { level: 3, name: "Gathered Swarm", description: "At 3rd level you gain swarmkeeper spells and a Gathered Swarm. Once on each of your turns when you hit a creature with an attack, you can choose one: deal 1d6 extra force damage to the target; or move the target 15 feet horizontally (Strength save vs your spell save DC negates); or you move 5 feet horizontally (doesn't provoke opportunity attacks). You can use this after seeing the hit." },
            { level: 7, name: "Writhing Tide", description: "At 7th level, as a bonus action you can gain a flying speed of 10 feet and the ability to hover for 1 minute (or until incapacitated). Uses equal to your proficiency bonus per long rest." },
            { level: 11, name: "Mighty Swarm", description: "At 11th level your Gathered Swarm's extra damage becomes 1d8. If you choose to move the target, it must also succeed on a Strength save or be knocked prone. If you choose to move yourself, you can move up to 15 feet." },
            { level: 15, name: "Swarming Dispersal", description: "At 15th level, when you take damage you can use your reaction to gain resistance to that damage and teleport up to 30 feet to an unoccupied space you can see. Uses equal to your proficiency bonus per long rest." }
        ],
        drakewarden: [
            // Fizban's Treasury of Dragons not in local extracts — expanded paraphrase from known mechanics
            { level: 3, name: "Draconic Gift & Drake Companion", description: "At 3rd level you learn thaumaturgy and one language of your choice among Draconic or others tied to dragons. As an action you can magically summon a Small drake companion in an unoccupied space within 30 feet. It acts on your initiative (after you), obeys your commands, and uses a special Drake Companion stat block that scales with your ranger level and proficiency bonus. You can summon it a number of times equal to your proficiency bonus per long rest, or by expending a spell slot of 1st level or higher. If it dies you can resummon it after a rest." },
            { level: 7, name: "Bond of Fang and Scale", description: "At 7th level your drake grows to Medium, gains a flying speed, and when you summon it you choose a damage type (its breath and resistance). While it is within 30 feet of you, you and the drake have resistance to that damage type. The drake also gains a breath weapon it can use." },
            { level: 11, name: "Drake's Breath", description: "At 11th level, as an action you or your drake (if within 30 feet) can exhale energy in a 30-foot cone; each creature in the area takes 6d6 damage of your chosen type (Dexterity save vs your spell save DC for half), increasing at higher levels. Once per long rest, or again by expending a spell slot of 3rd level or higher." },
            { level: 15, name: "Perfected Bond", description: "At 15th level your drake becomes Large, its bite and breath improve, and when you take the Attack action on your turn you can forgo one attack to command the drake to make one attack with its reaction." }
        ]
    },
    rogue: {
        thief: [
            { level: 3, name: "Fast Hands & Second-Story Work", description: "At 3rd level you can use the bonus action from Cunning Action to make a Dexterity (Sleight of Hand) check, use thieves' tools to disarm a trap or open a lock, or take the Use an Object action. Climbing also costs you no extra movement, and when you make a running jump the distance increases by a number of feet equal to your Dexterity modifier." },
            ...
            { level: 13, name: "Use Magic Device", description: "By 13th level you ignore all class, race, and level requirements on the use of magic items." },
            { level: 17, name: "Thief's Reflexes", description: "At 17th level you can take two turns during the first round of any combat: one at your normal initiative and one at your initiative minus 10. You can't use this feature when you are surprised." }
        ],
        assassin: [
            { level: 3, name: "Bonus Proficiencies & Assassinate", description: "At 3rd level you gain proficiency with the disguise kit and the poisoner's kit. You also have advantage on attack rolls against any creature that hasn't taken a turn in the combat yet, and any hit you score against a surprised creature is a critical hit." },
            { level: 9, name: "Infiltration Expertise", description: "Starting at 9th level, you can spend 7 days and 25 gp to establish a false identity (history, profession, affiliations, and supporting documents). You can't take another person's real identity. Thereafter, creatures believe you are that person until given an obvious reason not to." },
            { level: 13, name: "Impostor", description: "At 13th level, after studying a person's speech, writing, and mannerisms for at least 3 hours, you can unerringly mimic them. Casual observers can't tell the difference; against a wary creature you have advantage on Charisma (Deception) checks to avoid detection." },
            { level: 17, name: "Death Strike", description: "Starting at 17th level, when you attack and hit a surprised creature, it must make a Constitution saving throw (DC 8 + your Dexterity modifier + your proficiency bonus). On a failure, double the damage of your attack against it." }
        ],
        "arcane-trickster": [
            { level: 3, name: "Spellcasting & Mage Hand Legerdemain", description: "At 3rd level you gain spellcasting: Intelligence is your spellcasting ability; you learn mage hand plus two other wizard cantrips, and wizard spells that are mostly enchantment and illusion (with some exceptions at higher levels). When you cast mage hand, you can make the hand invisible and use it to stow or retrieve objects from containers worn by others, or use thieves' tools at range (unnoticed with a contested Sleight of Hand vs Perception). You can also control the hand with Cunning Action." },
            ...
            { level: 13, name: "Versatile Trickster", description: "At 13th level, as a bonus action you can designate a creature within 5 feet of your mage hand; you have advantage on attack rolls against that creature until the end of the turn." },
            { level: 17, name: "Spell Thief", description: "At 17th level, immediately after a creature casts a spell that targets you or includes you in its area, you can use your reaction to force a save with its spellcasting ability against your spell save DC. On a failure you negate the spell's effect against you and, if the spell is at least 1st level and of a level you can cast, you steal knowledge of it for 8 hours (cast with your slots) while the creature can't cast it. Once per long rest." }
        ],
        mastermind: [
            { level: 3, name: "Master of Intrigue & Master of Tactics", description: "At 3rd level you gain proficiency with the disguise kit, the forgery kit, and one gaming set of your choice, and you learn two languages. You can also unerringly mimic speech patterns and accents you have heard for at least 1 minute. Additionally, you can use the Help action as a bonus action, and when you Help a creature in attacking, the target can be within 30 feet of you if it can see or hear you." },
            { level: 9, name: "Insightful Manipulator", description: "Starting at 9th level, if you spend at least 1 minute observing or interacting with a creature outside combat, you learn how its Intelligence, Wisdom, and Charisma scores compare to yours, and whether its class levels (if any) are equal to, higher than, or lower than yours (DM's choice if it has no levels)." },
            { level: 13, name: "Misdirection", description: "Beginning at 13th level, when you are targeted by an attack while a creature within 5 feet of you is granting you cover against that attack, you can use your reaction to have the attack target that creature instead." },
            { level: 17, name: "Soul of Deceit", description: "Starting at 17th level, your thoughts can't be read by telepathy or other means unless you allow it. You can present false thoughts by succeeding on a Charisma (Deception) check contested by the reader's Wisdom (Insight). Magic that would determine if you are telling the truth always indicates you are truthful, and you can't be compelled to tell the truth by magic." }
        ],
        swashbuckler: [
            { level: 3, name: "Fancy Footwork & Rakish Audacity", description: "At 3rd level, when you make a melee attack against a creature during your turn, that creature can't make opportunity attacks against you for the rest of the turn. You also add your Charisma modifier to your initiative rolls. You don't need advantage on the attack roll to use Sneak Attack against a creature if you are within 5 feet of it, no other creatures are within 5 feet of you, and you don't have disadvantage on the attack roll (you still need a finesse or ranged weapon as usual)." },
            { level: 9, name: "Panache", description: "At 9th level, as an action you can make a Charisma (Persuasion) check contested by a creature's Wisdom (Insight); the creature must be able to hear you, and the two of you must share a language. On a success, if it is hostile it has disadvantage on attack rolls against targets other than you and can't make opportunity attacks against others for 1 minute (ends early if an ally damages or hits it, or you end your turn more than 60 feet away). If it isn't hostile it is charmed for 1 minute and regards you as a friendly acquaintance (ends early if you or allies harm it)." },
            { level: 13, name: "Elegant Maneuver", description: "Starting at 13th level, you can use a bonus action on your turn to gain advantage on the next Dexterity (Acrobatics) or Strength (Athletics) check you make during the same turn." },
            { level: 17, name: "Master Duelist", description: "Beginning at 17th level, when you miss with an attack roll, you can roll it again with advantage. Once per short or long rest." }
        ],
        inquisitive: [
            { level: 3, name: "Ear for Deceit, Eye for Detail & Insightful Fighting", description: "At 3rd level, when you make a Wisdom (Insight) check to determine whether a creature is lying, treat a roll of 7 or lower on the d20 as an 8. You can also use a bonus action to make a Wisdom (Perception) check to spot a hidden creature or object, or an Intelligence (Investigation) check to uncover or decipher clues. Additionally, as a bonus action you can make a Wisdom (Insight) check against a creature you can see that isn't incapacitated, contested by its Charisma (Deception). On a success, for 1 minute you can use Sneak Attack against it even without advantage if you don't have disadvantage (ends early if you designate another target or combat ends)." },
            { level: 9, name: "Steady Eye", description: "Starting at 9th level, you have advantage on Wisdom (Perception) and Intelligence (Investigation) checks if you move no more than half your speed on the same turn." },
            { level: 13, name: "Unerring Eye", description: "At 13th level, as an action you can sense the presence of illusions, shapechangers not in their true form, and other magic designed to deceive the senses within 30 feet of you, provided you aren't blinded or deafened. You sense something is deceptive but learn no specifics. Uses equal to your Wisdom modifier (minimum once) per long rest." },
            { level: 17, name: "Eye for Weakness", description: "At 17th level, while Insightful Fighting is active against a creature, your Sneak Attack damage against it increases by 3d6." }
        ],
        scout: [
            { level: 3, name: "Skirmisher & Survivalist", description: "At 3rd level, you can move up to half your speed as a reaction when an enemy ends its turn within 5 feet of you; this movement doesn't provoke opportunity attacks. You also gain proficiency in Nature and Survival if you don't already have them, and your proficiency bonus is doubled for any ability check you make that uses either of those skills." },
            { level: 9, name: "Superior Mobility", description: "At 9th level your walking speed increases by 10 feet. If you have a climbing or swimming speed, this increase applies to that speed as well." },
            { level: 13, name: "Ambush Master", description: "Starting at 13th level you have advantage on initiative rolls. In addition, the first creature you hit during the first round of a combat becomes easier for allies to hit: until the start of your next turn, other creatures have advantage on attack rolls against that target." },
            { level: 17, name: "Sudden Strike", description: "Starting at 17th level, if you take the Attack action on your turn, you can make one additional attack as a bonus action. This attack can benefit from your Sneak Attack even if you already used Sneak Attack this turn, but you can't apply Sneak Attack against the same target more than once in a turn." }
        ],
        phantom: [
            { level: 3, name: "Whispers of the Dead & Wails from the Grave", description: "At 3rd level, whenever you finish a short or long rest, you can gain one skill or tool proficiency of your choice (replacing any prior choice from this feature) as spirits share knowledge. Also, immediately after you deal Sneak Attack damage to a creature on your turn, you can target a second creature within 30 feet of the first that you can see; roll half your Sneak Attack dice (rounded up) and the second creature takes necrotic damage equal to the roll. Uses equal to your proficiency bonus per long rest." },
            { level: 9, name: "Tokens of the Departed", description: "At 9th level, when a creature you can see dies within 30 feet, you can use your reaction to form a Tiny soul trinket in your hand (you can have a number equal to your proficiency bonus). While you have at least one, you have advantage on death saving throws and Constitution saving throws. As an action you can destroy one trinket to ask the associated spirit a question (as speak with dead, without needing the corpse). When you use Wails from the Grave you can destroy a trinket to use the feature without expending a use." },
            { level: 13, name: "Ghost Walk", description: "At 13th level, as a bonus action you assume a spectral form for 10 minutes: you have a flying speed of 10 feet and can hover, you can move through creatures and objects as difficult terrain (1d10 force damage if you end your turn inside one), and attack rolls against you have disadvantage. Once per long rest, or again by destroying a soul trinket." },
            { level: 17, name: "Death's Friend", description: "At 17th level, when you use Wails from the Grave you can deal the necrotic damage to both the first and second creature. You also regain one soul trinket (associated with no specific spirit) whenever you finish a long rest if you have none remaining." }
        ],
        soulknife: [
            { level: 3, name: "Psionic Power & Psychic Blades", description: "At 3rd level you gain a pool of Psionic Energy dice (d6; number equals twice your proficiency bonus), which fuel telepathy and other options and return on a long rest (you regain one die on a short rest). You can also manifest a psychic blade as a free component of the Attack action: a melee weapon attack with a finesse simple weapon dealing 1d6 psychic damage (thrown 30/60, vanishes on hit or miss). After attacking with one blade on your turn, you can create a second and attack with it as a bonus action (1d4 psychic)." },
            { level: 9, name: "Soul Blades", description: "At 9th level your Psionic Energy die becomes a d8. Homing Strikes: if you miss with a Psychic Blade attack, you can roll one Psionic Energy die and add it to the attack roll (expended only if the attack then hits). Psychic Teleportation: as a bonus action expend a die, throw a psychic blade up to a number of feet equal to 5 × the die roll, and teleport to an unoccupied space you can see within a few feet of it." },
            { level: 13, name: "Psychic Veil", description: "At 13th level, as an action you can magically become invisible, along with anything you are wearing or carrying, for up to 1 hour or until you make an attack or force a creature to make a saving throw. Once per long rest, or again by expending a Psionic Energy die." },
            { level: 17, name: "Rend Mind", description: "At 17th level your Psionic Energy die becomes a d10. When you use Sneak Attack on a creature with your Psychic Blades, you can force it to make a Wisdom saving throw (DC 8 + your Dexterity modifier + your proficiency bonus). On a failure it is stunned until the end of your next turn. Once per long rest, or again by expending three Psionic Energy dice." }
        ]
    },
    sorcerer: {
        draconic: [
            { level: 1, name: "Dragon Ancestor & Draconic Resilience", description: "At 1st level choose a dragon type (and its associated damage type). You can speak, read, and write Draconic, and when you make a Charisma check interacting with dragons your proficiency bonus is doubled if it applies. Your hit point maximum increases by 1, and by 1 again whenever you gain a sorcerer level. When you aren't wearing armor, your AC equals 13 + your Dexterity modifier." },
            { level: 6, name: "Elemental Affinity", description: "Starting at 6th level, when you cast a spell that deals damage of the type associated with your draconic ancestry, you can add your Charisma modifier to one damage roll of that spell. You can also spend 1 sorcery point at the same time to gain resistance to that damage type for 1 hour." },
            { level: 14, name: "Dragon Wings", description: "At 14th level, as a bonus action you can sprout dragon wings and gain a flying speed equal to your current speed. Dismiss them as a bonus action. You can't manifest them while wearing armor unless it is made to accommodate them; other clothing may be destroyed." },
            { level: 18, name: "Draconic Presence", description: "Beginning at 18th level, as an action you can spend 5 sorcery points to exude an aura of awe or fear (your choice) out to 60 feet for 1 minute (concentration, as if concentrating on a spell). Each hostile creature that starts its turn in the aura must succeed on a Wisdom save or be charmed (awe) or frightened (fear) until the aura ends. A creature that succeeds is immune to your aura for 24 hours." }
        ],
        wild: [
            { level: 1, name: "Wild Magic Surge & Tides of Chaos", description: "At 1st level, once per turn the DM can have you roll a d20 immediately after you cast a sorcerer spell of 1st level or higher; on a 1, roll on the Wild Magic Surge table (surge spells ignore Metamagic and don't require concentration). Also, you can gain advantage on one attack roll, ability check, or saving throw (once per long rest). Before you regain that use, the DM can have you roll on the Wild Magic Surge table after you cast a sorcerer spell of 1st level or higher, after which you regain Tides of Chaos." },
            { level: 6, name: "Bend Luck", description: "Starting at 6th level, when another creature you can see makes an attack roll, ability check, or saving throw, you can use your reaction and spend 2 sorcery points to roll 1d4 and apply it as a bonus or penalty (your choice) to the roll, after the roll but before the outcome." },
            { level: 14, name: "Controlled Chaos", description: "At 14th level, whenever you roll on the Wild Magic Surge table, you can roll twice and use either number." },
            { level: 18, name: "Spell Bombardment", description: "Beginning at 18th level, when you roll damage for a spell and roll the highest number possible on any of the dice, choose one of those dice, roll it again, and add that roll to the damage. Once per turn." }
        ],
        storm: [
            { level: 1, name: "Wind Speaker & Tempestuous Magic", description: "At 1st level you can speak, read, and write Primordial (and its Auran, Aquan, Ignan, and Terran dialects). When you cast a spell of 1st level or higher, you can use a bonus action before or after casting to cause whirling wind to fly you up to 10 feet without provoking opportunity attacks." },
            { level: 6, name: "Heart of the Storm", description: "At 6th level you have resistance to lightning and thunder damage. Whenever you start casting a spell of 1st level or higher that deals lightning or thunder damage, stormy magic erupts: creatures of your choice within 10 feet of you take lightning or thunder damage (your choice) equal to half your sorcerer level." },
            { level: 14, name: "Storm Guide", description: "At 14th level, if it is raining you can use an action to cause the rain to stop falling in a 20-foot-radius sphere centered on you (you can end it as a bonus action). If it is windy, you can use a bonus action each turn to choose the direction of the wind within 100 feet of you until the end of your next turn (the wind's speed doesn't change)." },
            { level: 18, name: "Storm's Fury", description: "At 18th level, when you are hit by a melee attack, you can use your reaction to deal lightning damage to the attacker equal to your sorcerer level. The attacker must also make a Strength saving throw against your spell save DC; on a failure it is pushed up to 20 feet away from you in a straight line." }
        ],
        "divine-soul": [
            { level: 1, name: "Divine Magic & Favored by the Gods", description: "At 1st level your link to the divine lets you learn spells from the cleric list as well as the sorcerer list (they count as sorcerer spells for you). Choose an affinity (good, evil, law, chaos, or neutrality) that grants you an associated bonus spell. When you fail a saving throw or miss with an attack roll, you can roll 2d4 and add it to the total, possibly turning the failure into a success. Once per short or long rest." },
            { level: 6, name: "Empowered Healing", description: "At 6th level, whenever you or an ally within 5 feet of you rolls dice to determine the number of hit points a spell restores, you can spend 1 sorcery point to reroll any number of those dice once (must use the new rolls). You can use this only once per turn." },
            { level: 14, name: "Otherworldly Wings", description: "At 14th level, as a bonus action you can sprout spectral wings (appearance based on your affinity) and gain a flying speed of 30 feet. They last until you're incapacitated, you die, or you dismiss them as a bonus action." },
            { level: 18, name: "Unearthly Recovery", description: "At 18th level, as a bonus action when you have fewer than half your hit points remaining, you can regain hit points equal to half your hit point maximum. Once per long rest." }
        ],
        shadow: [
            { level: 1, name: "Eyes of the Dark & Strength of the Grave", description: "At 1st level you gain darkvision out to 120 feet and learn the darkness spell (it doesn't count against spells known). You can also cast it by spending 2 sorcery points, and when cast with sorcery points or a slot you can see through the darkness created by that casting. When damage reduces you to 0 hit points, you can make a Charisma saving throw (DC 5 + the damage taken); on a success you drop to 1 hit point instead. You can't use this if the damage is radiant or from a critical hit. Once per long rest." },
            { level: 6, name: "Hound of Ill Omen", description: "At 6th level, as a bonus action you can spend 3 sorcery points to summon a hound of ill omen (uses the dire wolf stat block with modifications) targeting one creature you can see within 120 feet. It appears within 30 feet of the target, moves toward it, can move through other creatures and objects as difficult terrain, and makes opportunity attacks only against the target. While the hound is within 5 feet of the target, the target has disadvantage on saving throws against any spell you cast. The hound disappears if it is reduced to 0 hit points, if its target drops to 0, or after 5 minutes." },
            { level: 14, name: "Shadow Walk", description: "At 14th level, when you are in dim light or darkness, you can use a bonus action to magically teleport up to 120 feet to an unoccupied space you can see that is also in dim light or darkness." },
            { level: 18, name: "Umbral Form", description: "At 18th level, as a bonus action you can spend 6 sorcery points to transform into a shadowy form for 1 minute. You have resistance to all damage except force and radiant, and you can move through other creatures and objects as difficult terrain (1d10 force damage if you end your turn inside a creature or object)." }
        ],
        "aberrant-mind": [
            { level: 1, name: "Psionic Spells & Telepathic Speech", description: "At 1st level you learn additional psionic spells as you gain sorcerer levels (they count as sorcerer spells and don't count against spells known; you can replace them when you gain levels). As a bonus action you can choose one creature you can see within 30 feet and talk telepathically with it for a number of minutes equal to your Charisma modifier (minimum 1). You must share a language. The connection ends early if the distance exceeds 2 × your sorcerer level in miles, if you use the feature on a different creature, or if either of you is incapacitated." },
            { level: 6, name: "Psionic Sorcery & Psychic Defenses", description: "At 6th level, when you cast any spell from your Psionic Spells feature, you can spend sorcery points equal to the spell's level instead of a spell slot (1 for a cantrip), casting it without verbal or somatic components and without material components that lack a cost. You also gain resistance to psychic damage, and advantage on saving throws against being charmed or frightened." },
            { level: 14, name: "Revelation in Flesh", description: "At 14th level, as a bonus action you can spend 1 or more sorcery points to transform for 10 minutes, choosing one benefit per point spent: swimming speed equal to walking speed and ability to breathe water and air; flying speed equal to walking speed and ability to hover; your body and equipment become slimy/malleable so you can move through spaces as narrow as 1 inch without squeezing; or blindsight 60 feet." },
            { level: 18, name: "Warping Implosion", description: "At 18th level, as an action you can teleport to an unoccupied space you can see within 120 feet. Immediately after you disappear, each creature within 30 feet of the space you left takes 3d10 force damage (Strength save vs your spell save DC for half) and on a failure is pulled straight toward the space you left, ending in an unoccupied space as close as possible. Once per long rest, or again by spending 5 sorcery points." }
        ],
        "clockwork-soul": [
            { level: 1, name: "Clockwork Magic & Restore Balance", description: "At 1st level you learn additional order-themed spells as you gain levels (they count as sorcerer spells and don't count against spells known; you can replace them when you gain levels). When a creature you can see within 60 feet is about to roll a d20 with advantage or disadvantage, you can use your reaction to prevent the roll from being affected by advantage or disadvantage. Uses equal to your proficiency bonus per long rest." },
            { level: 6, name: "Bastion of Law", description: "At 6th level, as an action you can spend 1 to 5 sorcery points to create a magical ward on yourself or another creature you can see within 30 feet. The ward lasts until you finish a long rest or you use this feature again. The ward has a number of d8s equal to the points spent. When the warded creature takes damage, it can expend and roll any number of those dice, reducing the damage by the total, then the expended dice are lost." },
            { level: 14, name: "Trance of Order", description: "At 14th level, as a bonus action you can enter a state of clockwork consciousness for 1 minute. Attack rolls against you can't benefit from advantage, and whenever you make an attack roll, ability check, or saving throw, you can treat a d20 roll of 9 or lower as a 10. Once per long rest, or again by spending 5 sorcery points." },
            { level: 18, name: "Clockwork Cavalcade", description: "At 18th level, as an action you summon spirit constructs in a 30-foot cube originating from you. They restore up to 100 hit points, divided as you choose among creatures in the cube that you can see; repair damaged objects not being worn or carried; and end every spell of 6th level or lower on creatures and objects of your choice in the cube. Once per long rest, or again by spending 7 sorcery points." }
        ]
    },
    warlock: {
        archfey: [
            { level: 1, name: "Fey Presence", description: "At 1st level, as an action you can force each creature in a 10-foot cube originating from you to make a Wisdom save against your warlock spell save DC. Creatures that fail are all charmed or frightened by you (your choice) until the end of your next turn. Once per short or long rest." },
            { level: 6, name: "Misty Escape", description: "Starting at 6th level, when you take damage you can use your reaction to turn invisible and teleport up to 60 feet to an unoccupied space you can see. You remain invisible until the start of your next turn or until you attack or cast a spell. Once per short or long rest." },
            { level: 10, name: "Beguiling Defenses", description: "Beginning at 10th level you are immune to being charmed. When another creature attempts to charm you, you can use your reaction to turn the charm back on it: it must succeed on a Wisdom save against your warlock spell save DC or be charmed by you for 1 minute or until it takes any damage." },
            { level: 14, name: "Dark Delirium", description: "Starting at 14th level, as an action choose a creature you can see within 60 feet. It must make a Wisdom save against your warlock spell save DC. On a failure it is charmed or frightened by you (your choice) for 1 minute or until your concentration ends (as if concentrating on a spell); the effect ends early if it takes damage. While affected it perceives only itself, you, and an illusory misty realm you choose. Once per short or long rest." }
        ],
        fiend: [
            ...
            { level: 6, name: "Dark One's Own Luck", description: "Starting at 6th level, when you make an ability check or saving throw you can add a d10 to the roll after seeing the initial roll but before the outcome. Once per short or long rest." },
            { level: 10, name: "Fiendish Resilience", description: "Starting at 10th level, when you finish a short or long rest choose one damage type. You have resistance to that type until you choose a different one with this feature. Damage from magical weapons or silvered weapons ignores this resistance." },
            { level: 14, name: "Hurl Through Hell", description: "Starting at 14th level, when you hit a creature with an attack you can send it through the lower planes. It disappears, then returns at the end of your next turn to the space it left (or the nearest unoccupied space). If it isn't a fiend, it takes 10d10 psychic damage. Once per long rest." }
        ],
        "great-old-one": [
            { level: 1, name: "Awakened Mind", description: "Starting at 1st level you can telepathically speak to any creature you can see within 30 feet. You don't need to share a language, but the creature must understand at least one language." },
            { level: 6, name: "Entropic Ward", description: "At 6th level, when a creature makes an attack roll against you, you can use your reaction to impose disadvantage on that roll. If the attack misses, your next attack roll against that creature before the end of your next turn has advantage. Once per short or long rest." },
            { level: 10, name: "Thought Shield", description: "Starting at 10th level your thoughts can't be read by telepathy or other means unless you allow it. You also have resistance to psychic damage, and whenever a creature deals psychic damage to you it takes the same amount of damage." },
            { level: 14, name: "Create Thrall", description: "At 14th level, as an action you can touch an incapacitated humanoid; it is charmed by you until remove curse is cast on it, the charmed condition is removed, or you use this feature again. You can communicate with it telepathically while you are on the same plane." }
        ],
        undying: [
            { level: 1, name: "Among the Dead", description: "Starting at 1st level you learn spare the dying as a warlock cantrip and have advantage on saves against disease. If an undead targets you directly with an attack or harmful spell, it must make a Wisdom save against your warlock spell save DC (area effects don't trigger this). On a failure it must choose a new target or waste the attack or spell; on a success it is immune to this effect for 24 hours. It is also immune for 24 hours if you target it with an attack or harmful spell." },
            { level: 6, name: "Defy Death", description: "Starting at 6th level, when you succeed on a death saving throw or stabilize a creature with spare the dying, you can regain hit points equal to 1d8 + your Constitution modifier (minimum 1). Once per long rest." },
            { level: 10, name: "Undying Nature", description: "Beginning at 10th level you can hold your breath indefinitely and don't require food, water, or sleep (you still need rest to reduce exhaustion and still benefit from short and long rests). For every 10 years that pass, your body ages only 1 year, and you are immune to being magically aged." },
            { level: 14, name: "Indestructible Life", description: "At 14th level, as a bonus action on your turn you can regain hit points equal to 1d8 + your warlock level. If you put a severed body part of yours back in place when you use this feature, it reattaches. Once per short or long rest." }
        ],
        celestial: [
            { level: 1, name: "Bonus Cantrips & Healing Light", description: "At 1st level you learn light and sacred flame (warlock cantrips that don't count against cantrips known). You also have a pool of d6s equal to 1 + your warlock level. As a bonus action heal one creature you can see within 60 feet, spending up to your Charisma modifier dice (minimum one) from the pool; the target regains hit points equal to the total. The pool refills on a long rest." },
            { level: 6, name: "Radiant Soul", description: "Starting at 6th level you have resistance to radiant damage. When you cast a spell that deals radiant or fire damage, you can add your Charisma modifier to one radiant or fire damage roll of that spell against one of its targets." },
            { level: 10, name: "Celestial Resilience", description: "Starting at 10th level, whenever you finish a short or long rest you gain temporary hit points equal to your warlock level + your Charisma modifier. Choose up to five creatures you can see at the end of the rest; each gains temporary hit points equal to half your warlock level + your Charisma modifier." },
            { level: 14, name: "Searing Vengeance", description: "Starting at 14th level, when you would make a death saving throw at the start of your turn, you can instead regain hit points equal to half your hit point maximum and stand up if you choose. Each creature of your choice within 30 feet takes radiant damage equal to 2d8 + your Charisma modifier and is blinded until the end of the current turn. Once per long rest." }
        ],
        hexblade: [
            { level: 1, name: "Hexblade's Curse & Hex Warrior", description: "At 1st level, as a bonus action curse one creature you can see within 30 feet for 1 minute (ends early if it dies, you die, or you are incapacitated). While cursed: you add your proficiency bonus to damage rolls against it; your attacks against it crit on 19–20; if it dies you regain hit points equal to your warlock level + your Charisma modifier (minimum 1). Once per short or long rest. You also gain proficiency with medium armor, shields, and martial weapons. Whenever you finish a long rest, you can touch one proficient weapon that lacks the two-handed property and use Charisma for its attack and damage rolls until your next long rest (extends to all pact weapons if you later gain Pact of the Blade)." },
            { level: 6, name: "Accursed Specter", description: "Starting at 6th level, when you slay a humanoid you can raise its spirit as a specter that gains temporary hit points equal to half your warlock level, has its own initiative, obeys your verbal commands, and adds your Charisma modifier (minimum +0) to its attack rolls. It serves until the end of your next long rest. Once per long rest." },
            { level: 10, name: "Armor of Hexes", description: "At 10th level, if the target of your Hexblade's Curse hits you with an attack roll, you can use your reaction to roll a d6; on a 4 or higher the attack misses you regardless of its roll." },
            { level: 14, name: "Master of Hexes", description: "Starting at 14th level, when a creature cursed by your Hexblade's Curse dies, you can apply the curse to a different creature you can see within 30 feet (provided you aren't incapacitated). When you transfer it this way, you don't regain hit points from the previous target's death." }
        ],
        fathomless: [
            { level: 1, name: "Tentacle of the Deeps & Gift of the Sea", description: "At 1st level, as a bonus action you can create a 10-foot tentacle at a point within 60 feet for 1 minute (or until you create another). On creation and as a bonus action on later turns, you can make a melee spell attack with it against a creature within 10 feet of it, dealing 1d8 cold damage (2d8 at 10th level) and reducing the target's speed by 10 feet until your next turn. Uses equal to your proficiency bonus per long rest. You also gain a swimming speed of 40 feet and can breathe underwater." },
            { level: 6, name: "Oceanic Soul & Guardian Coil", description: "At 6th level you gain resistance to cold damage. You can also communicate telepathically with any creature while both of you are underwater and within 120 feet. When you or a creature you can see takes damage while within 10 feet of your tentacle, you can use your reaction to choose that creature and reduce the damage by 1d8 (2d8 at 10th)." },
            { level: 10, name: "Grasping Tentacles", description: "At 10th level you learn Evard's black tentacles. You can cast it once without a spell slot per long rest, and you can cast it normally with slots. Whenever you cast it, you gain temporary hit points equal to your warlock level. Moreover, for its duration your concentration can't be broken as a result of taking damage." },
            { level: 14, name: "Fathomless Plunge", description: "At 14th level, as an action you can teleport yourself and up to five willing creatures of your choice that you can see within 30 feet. Each of you disappears in a swirl of water and teleports to an unoccupied space within 30 feet of a body of water you've seen (at least as large as a pond, lagoon, or larger) on the same plane, or to a space within 30 feet of water that appeared from your magic. Once per short or long rest." }
        ],
        genie: [
            { level: 1, name: "Genie's Vessel", description: "At 1st level choose a genie kind (dao, djinni, efreeti, or marid) that sets your expanded spells and damage type. You gain a Tiny vessel that can serve as a spellcasting focus. Bottled Respite: as an action you can magically vanish and enter the vessel (extradimensional space), remaining up to a number of hours equal to twice your proficiency bonus; you can exit early as a bonus action. Genie's Wrath: once during each of your turns when you hit with an attack roll, you can deal extra damage of your genie's type equal to your proficiency bonus." },
            { level: 6, name: "Elemental Gift", description: "At 6th level you gain resistance to a damage type based on your genie (bludgeoning for dao, thunder for djinni, fire for efreeti, cold for marid). As a bonus action you can give yourself a flying speed of 30 feet that lasts for 10 minutes (hover). Uses equal to your proficiency bonus per long rest." },
            { level: 10, name: "Sanctuary Vessel", description: "At 10th level, when you enter your Genie's Vessel you can choose up to five willing creatures you can see within 30 feet to enter with you. While inside, you and they can each gain the benefits of a short rest; once any of you finish that rest inside, no one can benefit from this feature again until you finish a long rest. When you exit, chosen creatures exit with you in unoccupied spaces of your choice within 10 feet." },
            { level: 14, name: "Limited Wish", description: "At 14th level, as an action you can speak your desire to your Genie's Vessel and produce the effect of any spell of 6th level or lower that has a casting time of 1 action, needing no components. Once you use this feature, you can't use it again until you finish 1d4 long rests." }
        ],
        undead: [
            // Van Richten's Guide to Ravenloft not in local extracts — expanded paraphrase from known mechanics
            { level: 1, name: "Form of Dread", description: "At 1st level, as a bonus action you transform for 1 minute (or until incapacitated): you gain temporary hit points equal to 1d10 + your warlock level, you are immune to the frightened condition, and once per turn when you hit a creature with an attack you can force it to make a Wisdom save against your warlock spell save DC or be frightened of you until the end of your next turn. Uses equal to your proficiency bonus per long rest." },
            { level: 6, name: "Grave Touched", description: "At 6th level you no longer need to eat, drink, or breathe. Once per turn when you hit with an attack roll and roll damage, you can change the damage type to necrotic. While Form of Dread is active, you can roll one extra damage die when you deal that necrotic damage." },
            { level: 10, name: "Necrotic Husk", description: "At 10th level you have resistance to necrotic damage. When you are reduced to 0 hit points, you can cause your body to explode: each creature within 30 feet takes necrotic damage equal to 2d10 + your warlock level (or half on a successful Constitution save vs your spell save DC), then you drop to 1 hit point and your Form of Dread ends if active. Once per long rest. While Form of Dread is active you can become immune to necrotic damage instead of resistant." },
            { level: 14, name: "Spirit Projection", description: "At 14th level, as an action you can project your spirit for up to 1 hour (concentration). Your body is unconscious and can't move; your spirit has resistance to bludgeoning, piercing, and slashing damage, a flying speed equal to your walking speed and hover, and can move through creatures and objects as difficult terrain (1d10 force if you end your turn inside one). Spells you cast that deal necrotic or radiant damage ignore resistance, and when you cast a spell on a creature while projected you can treat one roll of necrotic or radiant damage against it as maximized. Once per long rest." }
        ]
    },
    wizard: {
        abjuration: [
            { level: 2, name: "Abjuration Savant & Arcane Ward", description: "At 2nd level the gold and time to copy abjuration spells into your spellbook are halved. When you cast an abjuration spell of 1st level or higher, you can simultaneously create a magical ward on yourself that lasts until you finish a long rest. The ward has hit points equal to twice your wizard level + your Intelligence modifier. Whenever you take damage, the ward takes it instead; leftover damage hits you if the ward drops to 0. While at 0 HP the ward can't absorb damage but remains; casting another abjuration spell of 1st level or higher restores HP to the ward equal to twice the spell's level. Once you create the ward, you can't create it again until you finish a long rest." },
            { level: 6, name: "Projected Ward", description: "Starting at 6th level, when a creature you can see within 30 feet takes damage, you can use your reaction to have your Arcane Ward absorb that damage instead. If this reduces the ward to 0, the warded creature takes any remaining damage." },
            { level: 10, name: "Improved Abjuration", description: "Beginning at 10th level, when you cast an abjuration spell that requires an ability check as part of casting it (such as counterspell or dispel magic), you add your proficiency bonus to that check." },
            { level: 14, name: "Spell Resistance", description: "Starting at 14th level you have advantage on saving throws against spells, and you have resistance to damage from spells." }
        ],
        conjuration: [
            { level: 2, name: "Conjuration Savant & Minor Conjuration", description: "At 2nd level the gold and time to copy conjuration spells are halved. As an action you can conjure an inanimate nonmagical object you have seen in your hand or on the ground in an unoccupied space within 10 feet. It can be no larger than 3 feet on a side and weigh no more than 10 pounds, radiates dim light out to 5 feet, and disappears after 1 hour, when you use this feature again, or if it takes or deals any damage." },
            { level: 6, name: "Benign Transposition", description: "Starting at 6th level, as an action you can teleport up to 30 feet to an unoccupied space you can see, or swap places with a willing Small or Medium creature in a space within range. Once per long rest, or again when you cast a conjuration spell of 1st level or higher." },
            ...
            { level: 14, name: "Durable Summons", description: "Starting at 14th level, any creature you summon or create with a conjuration spell gains 30 temporary hit points." }
        ],
        divination: [
            { level: 2, name: "Divination Savant & Portent", description: "At 2nd level the gold and time to copy divination spells are halved. When you finish a long rest, roll two d20s and record the numbers. You can replace any attack roll, saving throw, or ability check made by you or a creature you can see with one of these rolls (choose before the roll; once per turn). Each foretelling roll can be used only once, and unused rolls are lost when you finish a long rest." },
            { level: 6, name: "Expert Divination", description: "Beginning at 6th level, when you cast a divination spell of 2nd level or higher using a spell slot, you regain one expended spell slot of a lower level than the spell you cast (maximum 5th level)." },
            { level: 10, name: "The Third Eye", description: "Starting at 10th level, as an action choose one benefit that lasts until you are incapacitated or you finish a short or long rest (then you can't use the feature again until you finish a rest): darkvision 60 feet; ethereal sight within 60 feet; ability to read any language; or see invisible creatures and objects within 10 feet that are in line of sight." },
            { level: 14, name: "Greater Portent", description: "Starting at 14th level you roll three d20s for Portent instead of two." }
        ],
        enchantment: [
            { level: 2, name: "Enchantment Savant & Hypnotic Gaze", description: "At 2nd level the gold and time to copy enchantment spells are halved. As an action choose one creature you can see within 5 feet that can see or hear you; it must succeed on a Wisdom save against your wizard spell save DC or be charmed until the end of your next turn, with speed 0 and incapacitated (visibly dazed). You can use your action on later turns to maintain it while you remain within 5 feet and it can see or hear you; it ends if the creature takes damage. Once it ends or the creature succeeds on the initial save, you can't use this on that creature again until you finish a long rest." },
            { level: 6, name: "Instinctive Charm", description: "Beginning at 6th level, when a creature you can see within 30 feet makes an attack roll against you, you can use your reaction to divert the attack (another creature must be within the attack's range). The attacker makes a Wisdom save against your wizard spell save DC; on a failure it must target the closest creature to it other than you or itself. Choose before knowing if the attack hits. Creatures immune to charm are immune. On a successful save you can't use this on that attacker again until you finish a long rest." },
            ...
            { level: 14, name: "Alter Memories", description: "At 14th level, when you cast an enchantment spell to charm one or more creatures, you can make one creature unaware it was charmed. Once before the spell ends, as an action you can force that creature to make an Intelligence save against your wizard spell save DC or lose up to 1 + your Charisma modifier hours of memory from the time it was charmed (minimum 1 hour; can't exceed the spell's duration)." }
        ],
        evocation: [
            { level: 2, name: "Evocation Savant & Sculpt Spells", description: "At 2nd level the gold and time to copy evocation spells are halved. When you cast an evocation spell that affects other creatures you can see, you can choose a number of them equal to 1 + the spell's level. The chosen creatures automatically succeed on their saving throws against the spell and take no damage if they would normally take half damage on a success." },
            { level: 6, name: "Potent Cantrip", description: "Starting at 6th level, when a creature succeeds on a saving throw against your cantrip, it still takes half the cantrip's damage (if any) but suffers no additional effect from the cantrip." },
            { level: 10, name: "Empowered Evocation", description: "Beginning at 10th level you add your Intelligence modifier to one damage roll of any wizard evocation spell you cast." },
            { level: 14, name: "Overchannel", description: "Starting at 14th level, when you cast a wizard spell of 1st through 5th level that deals damage, you can deal maximum damage with that spell. The first time you do so between long rests has no downside; each additional use before a long rest deals you 2d12 necrotic damage per spell level immediately after casting (increasing by 1d12 per spell level each further use). This damage ignores resistance and immunity." }
        ],
        illusion: [
            { level: 2, name: "Illusion Savant & Improved Minor Illusion", description: "At 2nd level the gold and time to copy illusion spells are halved. You learn minor illusion if you don't already know it (or another wizard cantrip if you do); it doesn't count against cantrips known. When you cast minor illusion, you can create both a sound and an image with a single casting." },
            { level: 6, name: "Malleable Illusions", description: "Starting at 6th level, when you cast an illusion spell with a duration of 1 minute or longer, you can use your action to change the nature of that illusion (within the spell's normal parameters), provided you can see the illusion." },
            { level: 10, name: "Illusory Self", description: "Beginning at 10th level, when a creature makes an attack roll against you, you can use your reaction to interpose an illusory duplicate; the attack automatically misses you, then the illusion dissipates. Once per short or long rest." },
            { level: 14, name: "Illusory Reality", description: "By 14th level, when you cast an illusion spell of 1st level or higher, you can choose one inanimate, nonmagical object that is part of the illusion and make it real as a bonus action while the spell is ongoing. It remains real for 1 minute. The object can't deal damage or otherwise directly harm anyone." }
        ],
        necromancy: [
            { level: 2, name: "Necromancy Savant & Grim Harvest", description: "At 2nd level the gold and time to copy necromancy spells are halved. Once per turn when you kill one or more creatures with a spell of 1st level or higher, you regain hit points equal to twice the spell's level, or three times its level if it is a necromancy spell. You don't gain this benefit for killing constructs or undead." },
            { level: 6, name: "Undead Thralls", description: "At 6th level you add animate dead to your spellbook if it isn't there. When you cast it you can target one additional corpse or pile of bones. Whenever you create an undead with a necromancy spell, its hit point maximum increases by your wizard level and it adds your proficiency bonus to its weapon damage rolls." },
            ...
            { level: 14, name: "Command Undead", description: "Starting at 14th level, as an action choose one undead you can see within 60 feet. It must make a Charisma save against your wizard spell save DC. On a success you can't use this feature on it again; on a failure it becomes friendly and obeys your commands until you use this feature again. Undead with Intelligence 8 or higher have advantage on the save; if Intelligence 12 or higher and it fails, it can repeat the save at the end of every hour until it succeeds and breaks free." }
        ],
        transmutation: [
            { level: 2, name: "Transmutation Savant & Minor Alchemy", description: "At 2nd level the gold and time to copy transmutation spells are halved. Over 10 minutes you can perform a special procedure on one object composed entirely of wood, stone (not a gemstone), iron, copper, or silver, transforming up to 1 cubic foot of it into a different one of those materials. After 1 hour, or until you lose concentration (as if concentrating on a spell), it reverts." },
            { level: 6, name: "Transmuter's Stone", description: "Starting at 6th level you can spend 8 hours creating a transmuter's stone. A creature holding it gains one benefit you choose: darkvision 60 feet; +10 feet speed while unencumbered; proficiency in Constitution saves; or resistance to acid, cold, fire, lightning, or thunder (your choice). Each time you cast a transmutation spell of 1st level or higher while the stone is on your person, you can change its effect. Creating a new stone ends the previous one." },
            { level: 10, name: "Shapechanger", description: "At 10th level you add polymorph to your spellbook if it isn't there. You can cast it without a spell slot targeting only yourself as a beast of CR 1 or lower. Once per short or long rest (you can still cast it with slots normally)." },
            { level: 14, name: "Master Transmuter", description: "Starting at 14th level, as an action you can consume your transmuter's stone (destroyed; remake after a long rest) for one effect: Major Transformation — spend 10 minutes to turn one nonmagical object no larger than a 5-foot cube into another of similar size, mass, and equal or lesser value; Panacea — remove all curses, diseases, and poisons from a creature you touch and restore all its hit points; Restore Life — cast raise dead without a slot or needing it in your book; Restore Youth — reduce a willing creature's apparent age by 3d10 years (minimum age 13; doesn't extend lifespan)." }
        ],
        bladesinging: [
            { level: 2, name: "Training in War and Song & Bladesong", description: "At 2nd level you gain proficiency with light armor, one type of one-handed melee weapon, and Performance (if you lack it). As a bonus action, if you aren't wearing medium or heavy armor or using a shield, you can start a Bladesong for 1 minute (ends early if you are incapacitated, don medium/heavy armor or a shield, or attack with a weapon using two hands; dismissible for free). While active: +Intelligence modifier to AC (minimum +1); walking speed +10 feet; advantage on Dexterity (Acrobatics); +Intelligence modifier (minimum +1) to Constitution saves to maintain concentration. Uses equal to your proficiency bonus per long rest." },
            { level: 6, name: "Extra Attack", description: "Starting at 6th level, when you take the Attack action you can attack twice instead of once. You can also replace one of those attacks with a casting of a cantrip that has a casting time of 1 action." },
            { level: 10, name: "Song of Defense", description: "Beginning at 10th level, while your Bladesong is active and you take damage, you can use your reaction to expend a spell slot and reduce that damage by 5 times the slot's level." },
            { level: 14, name: "Song of Victory", description: "Starting at 14th level, while your Bladesong is active you add your Intelligence modifier (minimum +1) to the damage of your melee weapon attacks." }
        ],
        "war-magic": [
            { level: 2, name: "Arcane Deflection & Tactical Wit", description: "At 2nd level, when you are hit by an attack or you fail a saving throw, you can use your reaction to gain +2 AC against that attack or +4 to that saving throw. Until the end of your next turn you can't cast spells other than cantrips. You also add your Intelligence modifier to your initiative rolls." },
            { level: 6, name: "Power Surge", description: "Starting at 6th level you can store power surges (maximum equal to your Intelligence modifier, minimum 1). After a long rest you have one; you gain one when you successfully end a spell with dispel magic or counterspell; if you end a short rest with none you gain one. Once per turn when you deal damage to a creature or object with a wizard spell, you can spend one surge to deal extra force damage equal to half your wizard level." },
            { level: 10, name: "Durable Magic", description: "Beginning at 10th level, while you maintain concentration on a spell you have a +2 bonus to AC and all saving throws." },
            { level: 14, name: "Deflecting Shroud", description: "At 14th level, when you use Arcane Deflection you can cause magical energy to arc from you: up to three creatures of your choice that you can see within 60 feet each take force damage equal to half your wizard level." }
        ],
        "order-of-scribes": [
            { level: 2, name: "Wizardly Quill & Awakened Spellbook", description: "At 2nd level, as a bonus action you create a Tiny magic quill that needs no ink, copies spells into your book in 2 minutes per level, and can erase its own writing as a bonus action within 5 feet. Your spellbook awakens: while holding it you can use it as a spellcasting focus; when you cast a wizard spell with a slot you can temporarily change its damage type to one from another spell in your book of the same level as the slot; and once per long rest you can cast a ritual at its normal casting time without the +10 minutes. You can transfer the book's consciousness into a new blank book or attuned magic spellbook over a short rest." },
            { level: 6, name: "Manifest Mind", description: "At 6th level, as a bonus action while your book is on your person you conjure its mind as a Tiny spectral object within 60 feet (dim light 10 feet; sees and hears with 60-foot darkvision; shares senses telepathically). Whenever you cast a wizard spell on your turn you can cast it from the mind's space using its senses (proficiency bonus times per long rest). Move it up to 30 feet as a bonus action. Once per long rest, or again by expending a spell slot of any level." },
            { level: 10, name: "Master Scrivener", description: "At 10th level, whenever you finish a long rest you can create one magic scroll of a 1st- or 2nd-level spell from your Awakened Spellbook that has a casting time of 1 action; in the scroll it counts as one level higher. Only you can cast it (as an action); it vanishes when cast or when you finish your next long rest. Gold and time to craft other spell scrolls are halved when you use your Wizardly Quill." },
            { level: 14, name: "One with the Word", description: "At 14th level, while your spellbook is on your person you have advantage on Intelligence (Arcana) checks. If you take damage while the book's mind is manifested, you can use your reaction to dismiss the mind and prevent all of that damage; then roll 3d6 and the book temporarily loses spells of your choice whose combined levels equal that total or higher (you can't cast the lost spells until you finish 1d6 long rests). If there aren't enough spells to cover the cost you drop to 0 hit points. Once per long rest." }
        ],
        chronurgy: [
            { level: 2, name: "Chronal Shift & Temporal Awareness", description: "At 2nd level, as a reaction after you or a creature you can see within 30 feet makes an attack roll, ability check, or saving throw, you can force it to reroll (decide after you see success or failure; the target must use the second roll). Twice per long rest. You also add your Intelligence modifier to your initiative rolls." },
            { level: 6, name: "Momentary Stasis", description: "At 6th level, as an action force a Large or smaller creature you can see within 60 feet to make a Constitution save against your spell save DC. On a failure it is encased until the end of your next turn or until it takes any damage: incapacitated with speed 0. Uses equal to your Intelligence modifier (minimum once) per long rest." },
            { level: 10, name: "Arcane Abeyance", description: "At 10th level, when you cast a spell using a spell slot of 4th level or lower, you can condense it into a Tiny gray bead (AC 15, 1 HP, immune to poison and psychic) for 1 hour. A creature holding the bead can use its action to release the spell (uses your attack bonus and save DC; that creature is treated as the caster otherwise). If the duration ends or the bead is destroyed, the spell is lost. Once per short or long rest." },
            { level: 14, name: "Convergent Future", description: "At 14th level, when you or a creature you can see within 60 feet makes an attack roll, ability check, or saving throw, you can use your reaction to ignore the die roll and decide whether the number rolled is the minimum needed to succeed or one less than that number. When you use this feature you gain one level of exhaustion that can be removed only by finishing a long rest." }
        ],
        graviturgy: [
            { level: 2, name: "Adjust Density", description: "At 2nd level, as an action alter the weight of one Large or smaller object or creature you can see within 30 feet for up to 1 minute (concentration). Halved weight: +10 feet speed, jump twice as far, disadvantage on Strength checks and saves. Doubled weight: −10 feet speed, advantage on Strength checks and saves. At 10th level you can target Huge or smaller." },
            { level: 6, name: "Gravity Well", description: "At 6th level, whenever you cast a spell on a creature, you can move the target 5 feet to an unoccupied space of your choice if it is willing, the spell hits it with an attack, or it fails a saving throw against the spell." },
            { level: 10, name: "Violent Attraction", description: "At 10th level, when another creature you can see within 60 feet hits with a weapon attack, you can use your reaction to deal an extra 1d10 damage of the weapon's type to the attack's target. Alternatively, if a creature within 60 feet takes damage from a fall, you can use your reaction to increase the fall damage by 2d10. Uses equal to your Intelligence modifier (minimum once) per long rest." },
            { level: 14, name: "Event Horizon", description: "At 14th level, as an action emit a gravitational field for up to 1 minute (concentration). Whenever a creature hostile to you starts its turn within 30 feet of you, it must make a Strength save against your spell save DC. On a failure it takes 2d10 force damage and its speed is 0 until the start of its next turn; on a success it takes half damage and every foot of movement costs 2 extra feet this turn. Once per long rest, or again by expending a spell slot of 3rd level or higher." }
        ]
    },
    artificer: {
        alchemist: [
            { level: 3, name: "Tool Proficiency & Experimental Elixir", description: "At 3rd level you gain proficiency with alchemist's supplies (or another artisan's tool if you already have it) and always have certain alchemist spells prepared. Whenever you finish a long rest, you can magically produce an experimental elixir in an empty flask (roll for a random effect such as healing, swiftness, resilience, boldness, flight, or transformation). As an action a creature can drink it or administer it to an incapacitated creature. You can create additional elixirs by expending a spell slot of 1st level or higher (choose the effect). Elixirs require alchemist's supplies and last until drunk or until the end of your next long rest. You produce more at higher levels (two at 6th, three at 15th)." },
            { level: 5, name: "Alchemical Savant", description: "At 5th level, whenever you cast a spell using alchemist's supplies as the focus, you gain a bonus equal to your Intelligence modifier (minimum +1) to one roll of the spell that restores hit points or deals acid, fire, necrotic, or poison damage." },
            { level: 9, name: "Restorative Reagents", description: "At 9th level, whenever a creature drinks an experimental elixir you created, it also gains temporary hit points equal to 2d6 + your Intelligence modifier (minimum 1). You can also cast lesser restoration without a spell slot or preparing it (using alchemist's supplies as the focus) a number of times equal to your Intelligence modifier (minimum once) per long rest." },
            { level: 15, name: "Chemical Mastery", description: "At 15th level you gain resistance to acid and poison damage and immunity to the poisoned condition. You can cast greater restoration and heal each once per long rest without a spell slot, preparation, or material components, provided you use alchemist's supplies as the focus." }
        ],
        armorer: [
            { level: 3, name: "Tools of the Trade, Arcane Armor & Armor Model", description: "At 3rd level you gain proficiency with heavy armor and smith's tools (or another tool if you already have smith's), and always have certain armorer spells prepared. As an action with smith's tools in hand you turn armor you are wearing into Arcane Armor: no Strength requirement for you, usable as a spellcasting focus, attaches and can't be removed against your will, covers your body (helmet retracts as a bonus action), replaces missing limbs, and can be doffed or donned as an action. Choose Guardian (thunder gauntlets dealing 1d8 thunder and imposing disadvantage on attacks vs others; Defensive Field bonus-action temp HP equal to your artificer level, proficiency bonus times per long rest) or Infiltrator (lightning launcher 1d6 lightning at 90/300 with +1d6 once per turn; +5 feet speed; advantage on Stealth). Change model after a rest with smith's tools. Attacks with the special weapon use Intelligence." },
            { level: 5, name: "Extra Attack", description: "At 5th level you can attack twice, rather than once, whenever you take the Attack action on your turn." },
            { level: 9, name: "Armor Modifications", description: "At 9th level your Arcane Armor counts as separate items for Infuse Item (chest, boots, helmet, and special weapon), each able to bear an infusion. Your maximum infused items increases by 2, but those extras must be part of your Arcane Armor." },
            { level: 15, name: "Perfected Armor", description: "At 15th level your model improves. Guardian: when a Huge or smaller creature you can see ends its turn within 30 feet, you can use your reaction to force a Strength save against your spell save DC, pulling it up to 30 feet toward you; if it ends within 5 feet you can make a melee weapon attack as part of the reaction (proficiency bonus times per long rest). Infiltrator: a creature that takes lightning damage from your Lightning Launcher glimmers until the start of your next turn (dim light 5 feet, disadvantage on attacks against you); the next attack roll against it has advantage, and on a hit deals an extra 1d6 lightning damage." }
        ],
        artillerist: [
            { level: 3, name: "Tool Proficiency & Eldritch Cannon", description: "At 3rd level you gain proficiency with woodcarver's tools (or another tool if you already have it) and always have certain artillerist spells prepared. As an action with woodcarver's or smith's tools you create a Small or Tiny eldritch cannon on a horizontal surface within 5 feet (AC 18; HP equal to five times your artificer level; immune to poison and psychic; lasts 1 hour or until destroyed). Once per long rest, or again by expending a spell slot; only one at a time. Choose Flamethrower (15-foot cone, 2d8 fire, Dexterity save), Force Ballista (ranged spell attack within 120 feet, 2d8 force and push 5 feet), or Protector (temp HP equal to 1d8 + Intelligence mod to itself and chosen creatures within 10 feet). Activate as a bonus action within 60 feet; if it has legs, also walk or climb 15 feet as part of that bonus action." },
            { level: 5, name: "Arcane Firearm", description: "At 5th level, when you finish a long rest you can use woodcarver's tools to turn a wand, staff, or rod into your arcane firearm (sigils last until you carve them on a different item). It can be a spellcasting focus for artificer spells. When you cast an artificer spell through it, roll a d8 and add it to one of the spell's damage rolls." },
            { level: 9, name: "Explosive Cannon", description: "At 9th level your cannon's damage rolls increase by 1d8. As an action within 60 feet you can command it to detonate, destroying it and forcing each creature within 20 feet to make a Dexterity save against your spell save DC, taking 3d8 force damage on a failure or half on a success." },
            { level: 15, name: "Fortified Position", description: "At 15th level you and your allies have half cover while within 10 feet of a cannon you create. You can have two cannons at once, create two with the same action (but not the same spell slot), and activate both with the same bonus action." }
        ],
        "battle-smith": [
            { level: 3, name: "Battle Ready & Steel Defender", description: "At 3rd level you gain proficiency with martial weapons and smith's tools (or another tool), always have certain battle smith spells prepared, and when you attack with a magic weapon you can use Intelligence for attack and damage rolls. You also create a Steel Defender construct (Medium; AC 15; HP based on your Intelligence and artificer level; speed 40 feet; Force-Empowered Rend; Repair; Deflect Attack reaction). It shares your initiative (acts after you), Dodges unless commanded as a bonus action, can be mended for 2d6 HP, and can be revived within an hour by expending a 1st-level or higher spell slot. Creating a new one after a long rest destroys the old; it also perishes if you die." },
            { level: 5, name: "Extra Attack", description: "At 5th level you can attack twice, rather than once, whenever you take the Attack action on your turn." },
            { level: 9, name: "Arcane Jolt", description: "At 9th level, when you hit a target with a magic weapon attack or your Steel Defender hits a target, you can channel energy (once per turn) to either deal an extra 2d6 force damage to the target or restore 2d6 hit points to one creature or object you can see within 30 feet of the target. Uses equal to your Intelligence modifier (minimum once) per long rest." },
            { level: 15, name: "Improved Defender", description: "At 15th level your Arcane Jolt damage and healing both increase to 4d6. Your Steel Defender gains +2 AC, and whenever it uses Deflect Attack the attacker takes force damage equal to 1d4 + your Intelligence modifier." }
        ]
    }
...
function getSavingThrows(characterClasses, modifiers, proficiencyBonus) {
    const saves = {};
    ['str', 'dex', 'con', 'int', 'wis', 'cha'].forEach(stat => {
        saves[stat] = { mod: modifiers[stat], proficient: false, total: modifiers[stat] };
    });
    ...
    characterClasses.forEach(cc => {
        ...
        if (classData && classData.savingThrows) {
            classData.savingThrows.forEach(save => {
                if (saves[save] && !saves[save].proficient) {
                    saves[save].proficient = true;
                    saves[save].total = saves[save].mod + proficiencyBonus;
                }
            });
        }
    });
...
// Get hit dice string for character
function getHitDiceString(characterClasses) {
    const hitDice = [];
    characterClasses.forEach(cc => {
        if (cc.className === 'commoner' || cc.level === 0) return;
        const classData = classes[cc.className];
        if (classData && classData.hitDie) {
            hitDice.push(cc.level + classData.hitDie);
        }
    });
    return hitDice.length > 0 ? hitDice.join(' + ') : 'None';
}

// Get weapon proficiencies for display
function getWeaponProficiencyText(characterClasses) {
    let simple = false, martial = false;
    const specific = [];
    
    characterClasses.forEach(cc => {
        const prof = classWeaponProficiencies[cc.className];
        if (prof) {
            if (prof.simple) simple = true;
            if (prof.martial) martial = true;
            if (prof.specific) {
                prof.specific.forEach(w => {
                    if (!specific.includes(w)) specific.push(w);
                });
            }
        }
    });
    ...
    const parts = [];
    if (simple && martial) parts.push('All weapons');
    else if (simple) parts.push('Simple weapons');
    else if (martial) parts.push('Martial weapons');
    if (specific.length > 0 && !martial) {
        parts.push(specific.map(w => weapons[w]?.name || w).join(', '));
    }
    return parts.length > 0 ? parts.join(', ') : 'None';
}

// Get armor proficiencies for display
function getArmorProficiencyText(characterClasses) {
    ...
    const profs = new Set();
    characterClasses.forEach(cc => {
        (classArmorProfs[cc.className] || []).forEach(p => profs.add(p));
    });
    
    return profs.size > 0 ? Array.from(profs).join(', ') : 'None';
}
...
const spells = {
    ...
    'water-walk': { name: 'Water Walk', level: 3, school: 'transmutation', castingTime: '1 action', range: '30 feet', components: { v: true, s: true, m: 'A piece of cork' }, duration: '1 hour', concentration: false, ritual: true, classes: ['artificer', 'cleric', 'druid', 'ranger', 'sorcerer'], description: 'This spell grants the ability to move across any liquid surface—such as water, acid, mud, snow, quicksand, or lava—as if it were harmless solid ground (creatures crossing molten lava can still take damage from the heat).', source: 'PHB' },
    ...
    'find-the-path': { name: 'Find the Path', level: 6, school: 'divination', castingTime: '1 minute', range: 'Self', components: { v: true, s: true, m: 'A set of divinatory tools—such as bones, ivory sticks, cards, teeth, or carved runes—worth 100 gp and an object from the location you wish to find' }, duration: 'Concentration, up to 1 day', concentration: true, ritual: false, classes: ['bard', 'cleric', 'druid'], description: 'This spell allows you to find the shortest, most direct physical route to a specific fixed location that you are familiar with on the same plane of existence.', source: 'PHB' },
    ...
    'cloud-of-daggers': { name: 'Cloud of Daggers', level: 2, school: 'conjuration', castingTime: '1 action', range: '60 feet', components: { v: true, s: true, m: 'A sliver of glass' }, duration: 'Concentration, up to 1 minute', concentration: true, ritual: false, classes: ['bard', 'sorcerer', 'warlock', 'wizard'], description: 'You fill the air with spinning daggers in a cube 5 feet on each side, centered on a point you choose within range. A creature takes 4d4 slashing damage when it enters the spell\'s area for the first time on a turn or starts its turn there.', source: 'PHB' },
    'cordon-of-arrows': { name: 'Cordon of Arrows', level: 2, school: 'transmutation', castingTime: '1 action', range: '5 feet', components: { v: true, s: true, m: 'Four or more arrows or bolts' }, duration: '8 hours', concentration: false, ritual: false, classes: ['ranger'], description: 'You plant four pieces of nonmagical ammunition—arrows or crossbow bolts—in the ground within range and lay magic upon them to protect an area. Until the spell ends, whenever a creature other than you comes within 30 feet of the ammunition for the first time on a turn or ends its turn there, one piece of ammunition flies up to strike it.', source: 'PHB' },
